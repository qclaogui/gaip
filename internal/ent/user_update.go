...
func (uu *UserUpdate) defaults() {
	if _, ok := uu.mutation.LastActive(); !ok {
		v := user.UpdateDefaultLastActive()
		uu.mutation.SetLastActive(v)
	}
}
...
func (uuo *UserUpdateOne) defaults() {
	if _, ok := uuo.mutation.LastActive(); !ok {
		v := user.UpdateDefaultLastActive()
		uuo.mutation.SetLastActive(v)
	}
}
