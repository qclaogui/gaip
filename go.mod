...
require (
	...
	github.com/grafana/dskit v0.0.0-20240724161724-90da9087cc55
...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.0.0-20240725014237-48f6a11b7580 // indirect
