...
const (
	...
	// FinishReasonStop means token generation reached a natural stopping point or a configured stop
	// sequence.
	FinishReasonStop FinishReason = 1
	// FinishReasonMaxTokens means token generation reached the configured maximum output tokens.
	FinishReasonMaxTokens FinishReason = 2
	// FinishReasonSafety means token generation stopped because the content potentially contains safety
	...
	// FinishReasonRecitation means token generation stopped because the content potentially contains
...
const (
	...
	// FunctionCallingAuto means default model behavior, model decides to predict either function calls
	// or natural language response.
	FunctionCallingAuto FunctionCallingMode = 1
	// FunctionCallingAny means model is constrained to always predicting function calls only.
	...
	// FunctionCallingNone means model will not predict any function calls. Model behavior is same as when
...
type FunctionDeclaration struct {
	...
	ParametersJsonSchema *structpb.Value
...
func (v *FunctionDeclaration) toProto() *pb.FunctionDeclaration {
	...
	return &pb.FunctionDeclaration{
		...
		ParametersJsonSchema: v.ParametersJsonSchema,
...
func (FunctionDeclaration) fromProto(p *pb.FunctionDeclaration) *FunctionDeclaration {
	...
	return &FunctionDeclaration{
		...
		ParametersJsonSchema: p.ParametersJsonSchema,
...
const (
	...
	// HarmCategoryCivicIntegrity means deprecated: Election filter is not longer supported.
	// The harm category is civic integrity.
	//
	// Deprecated: Marked as deprecated in qclaogui/aiplatform/v1beta1/content.proto.
	HarmCategoryCivicIntegrity HarmCategory = 5
)
...
type Schema struct {
	...
	AdditionalProperties *structpb.Value
...
func (v *Schema) toProto() *pb.Schema {
	...
	return &pb.Schema{
		...
		Ref:                  v.Ref,
		Defs:                 pvTransformMapValues(v.Defs, (*Schema).toProto),
	}
}
...
func (Schema) fromProto(p *pb.Schema) *Schema {
	...
	return &Schema{
		...
		Ref:                  p.Ref,
		Defs:                 pvTransformMapValues(p.Defs, (Schema{}).fromProto),
	}
}
