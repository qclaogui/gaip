...
const (
	BookstoreService_ListShelves_FullMethodName = "/bookstore.v1beta1.BookstoreService/ListShelves"
	BookstoreService_CreateShelf_FullMethodName = "/bookstore.v1beta1.BookstoreService/CreateShelf"
	BookstoreService_GetShelf_FullMethodName    = "/bookstore.v1beta1.BookstoreService/GetShelf"
	BookstoreService_DeleteShelf_FullMethodName = "/bookstore.v1beta1.BookstoreService/DeleteShelf"
	BookstoreService_ListBooks_FullMethodName   = "/bookstore.v1beta1.BookstoreService/ListBooks"
	BookstoreService_CreateBook_FullMethodName  = "/bookstore.v1beta1.BookstoreService/CreateBook"
	BookstoreService_GetBook_FullMethodName     = "/bookstore.v1beta1.BookstoreService/GetBook"
	BookstoreService_DeleteBook_FullMethodName  = "/bookstore.v1beta1.BookstoreService/DeleteBook"
)
...
func (c *bookstoreServiceClient) GetShelf(ctx context.Context, in *GetShelfRequest, opts ...grpc.CallOption) (*Shelf, error) {
	out := new(Shelf)
	err := c.cc.Invoke(ctx, BookstoreService_GetShelf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookstoreServiceClient) ListBooks(ctx context.Context, in *ListBooksRequest, opts ...grpc.CallOption) (*ListBooksResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookstoreService_ListBooks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var BookstoreService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bookstore.v1beta1.BookstoreService",
	...
	Metadata: "bookstore/v1beta1/bookstore.proto",
}
