...
func file_qclaogui_generativelanguage_v1_safety_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_qclaogui_generativelanguage_v1_safety_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_qclaogui_generativelanguage_v1_safety_proto_msgTypes[1].Exporter = func(v any, i int) any {
