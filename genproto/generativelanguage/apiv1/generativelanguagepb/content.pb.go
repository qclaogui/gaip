...
func file_qclaogui_generativelanguage_v1_content_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_qclaogui_generativelanguage_v1_content_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_qclaogui_generativelanguage_v1_content_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Part); i {
			case 0:
				return &v.state
			case 1:
		...
		file_qclaogui_generativelanguage_v1_content_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Blob); i {
			case 0:
				return &v.state
			case 1:
