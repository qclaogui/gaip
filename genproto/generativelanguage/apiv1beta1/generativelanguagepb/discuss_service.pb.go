...
const file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDesc = "" +
	"\n" +
	"9qclaogui/generativelanguage/v1beta1/discuss_service.proto\x12#qclaogui.generativelanguage.v1beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a2qclaogui/generativelanguage/v1beta1/citation.proto\x1a0qclaogui/generativelanguage/v1beta1/safety.proto\"\x89\x03\n" +
	"\x16GenerateMessageRequest\x12D\n" +
	"\x05model\x18\x01 \x01(\tB.\xe2A\x01\x02\xfaA'\n" +
	"%generativelanguage.qclaogui.com/ModelR\x05model\x12P\n" +
	"\x06prompt\x18\x02 \x01(\v22.qclaogui.generativelanguage.v1beta1.MessagePromptB\x04\xe2A\x01\x02R\x06prompt\x12+\n" +
	...
	"\x06_top_pB\b\n" +
	"\x06_top_k\"\xff\x01\n" +
	"\x17GenerateMessageResponse\x12L\n" +
	"\n" +
	"candidates\x18\x01 \x03(\v2,.qclaogui.generativelanguage.v1beta1.MessageR\n" +
	"candidates\x12H\n" +
	"\bmessages\x18\x02 \x03(\v2,.qclaogui.generativelanguage.v1beta1.MessageR\bmessages\x12L\n" +
	"\afilters\x18\x03 \x03(\v22.qclaogui.generativelanguage.v1beta1.ContentFilterR\afilters\"\xcc\x01\n" +
	"\aMessage\x12\x1c\n" +
	"\x06author\x18\x01 \x01(\tB\x04\xe2A\x01\x01R\x06author\x12\x1e\n" +
	"\acontent\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\acontent\x12m\n" +
	...
	"\x12_citation_metadata\"\xcf\x01\n" +
	"\rMessagePrompt\x12\x1e\n" +
	"\acontext\x18\x01 \x01(\tB\x04\xe2A\x01\x01R\acontext\x12N\n" +
	"\bexamples\x18\x02 \x03(\v2,.qclaogui.generativelanguage.v1beta1.ExampleB\x04\xe2A\x01\x01R\bexamples\x12N\n" +
	"\bmessages\x18\x03 \x03(\v2,.qclaogui.generativelanguage.v1beta1.MessageB\x04\xe2A\x01\x02R\bmessages\"\x9f\x01\n" +
	"\aExample\x12H\n" +
	"\x05input\x18\x01 \x01(\v2,.qclaogui.generativelanguage.v1beta1.MessageB\x04\xe2A\x01\x02R\x05input\x12J\n" +
	"\x06output\x18\x02 \x01(\v2,.qclaogui.generativelanguage.v1beta1.MessageB\x04\xe2A\x01\x02R\x06output\"\xb3\x01\n" +
	"\x19CountMessageTokensRequest\x12D\n" +
	"\x05model\x18\x01 \x01(\tB.\xe2A\x01\x02\xfaA'\n" +
	"%generativelanguage.qclaogui.com/ModelR\x05model\x12P\n" +
	"\x06prompt\x18\x02 \x01(\v22.qclaogui.generativelanguage.v1beta1.MessagePromptB\x04\xe2A\x01\x02R\x06prompt\"=\n" +
	"\x1aCountMessageTokensResponse\x12\x1f\n" +
	"\vtoken_count\x18\x01 \x01(\x05R\n" +
	"tokenCount2\x8e\x04\n" +
	"\x0eDiscussService\x12\xf8\x01\n" +
	"\x0fGenerateMessage\x12;.qclaogui.generativelanguage.v1beta1.GenerateMessageRequest\x1a<.qclaogui.generativelanguage.v1beta1.GenerateMessageResponse\"j\xdaA4model,prompt,temperature,candidate_count,top_p,top_k\x82\xd3\xe4\x93\x02-:\x01*\"(/v1beta/{model=models/*}:generateMessage\x12\xdc\x01\n" +
	"\x12CountMessageTokens\x12>.qclaogui.generativelanguage.v1beta1.CountMessageTokensRequest\x1a?.qclaogui.generativelanguage.v1beta1.CountMessageTokensResponse\"E\xdaA\fmodel,prompt\x82\xd3\xe4\x93\x020:\x01*\"+/v1beta/{model=models/*}:countMessageTokens\x1a\"\xcaA\x1fgenerativelanguage.qclaogui.comBVZTgithub.com/qclaogui/gaip/genproto/generativelanguage/apiv1beta1/generativelanguagepbb\x06proto3"
