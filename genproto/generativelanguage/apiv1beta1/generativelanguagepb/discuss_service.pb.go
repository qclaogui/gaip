...
var file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDesc = []byte{
...
var (
	...
	file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDescData = file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDesc
)
...
func file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDescGZIP() []byte {
	file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDescOnce.Do(func() {
		file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDescData)
	})
...
func file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_qclaogui_generativelanguage_v1beta1_discuss_service_proto_rawDesc = nil
