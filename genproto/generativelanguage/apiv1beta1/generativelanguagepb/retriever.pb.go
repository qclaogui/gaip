...
const file_qclaogui_generativelanguage_v1beta1_retriever_proto_rawDesc = "" +
	"\n" +
	"3qclaogui/generativelanguage/v1beta1/retriever.proto\x12#qclaogui.generativelanguage.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa2\x02\n" +
	"\x06Corpus\x12\x19\n" +
	...
	"updateTime:N\xeaAK\n" +
	"&generativelanguage.qclaogui.com/Corpus\x12\x10corpora/{corpus}*\acorpora2\x06corpus\"\xa3\x03\n" +
	"\bDocument\x12\x19\n" +
	"\x04name\x18\x01 \x01(\tB\x05\xe2A\x02\b\x05R\x04name\x12'\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\vdisplayName\x12b\n" +
	"\x0fcustom_metadata\x18\x03 \x03(\v23.qclaogui.generativelanguage.v1beta1.CustomMetadataB\x04\xe2A\x01\x01R\x0ecustomMetadata\x12A\n" +
	"\vupdate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x04\xe2A\x01\x03R\n" +
	"updateTime\x12A\n" +
	...
	"\x11string_list_value\x18\x06 \x01(\v2/.qclaogui.generativelanguage.v1beta1.StringListH\x00R\x0fstringListValue\x12%\n" +
	...
	"\x03key\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x03key\x12T\n" +
	"\n" +
	"conditions\x18\x02 \x03(\v2..qclaogui.generativelanguage.v1beta1.ConditionB\x04\xe2A\x01\x02R\n" +
	"conditions\"\xd4\x02\n" +
	"\tCondition\x12#\n" +
	"\fstring_value\x18\x01 \x01(\tH\x00R\vstringValue\x12%\n" +
	"\rnumeric_value\x18\x06 \x01(\x02H\x00R\fnumericValue\x12[\n" +
	"\toperation\x18\x05 \x01(\x0e27.qclaogui.generativelanguage.v1beta1.Condition.OperatorB\x04\xe2A\x01\x02R\toperation\"\x94\x01\n" +
	"\bOperator\x12\x18\n" +
	...
	"\x05value\"\xf7\x04\n" +
	"\x05Chunk\x12\x19\n" +
	"\x04name\x18\x01 \x01(\tB\x05\xe2A\x02\b\x05R\x04name\x12H\n" +
	"\x04data\x18\x02 \x01(\v2..qclaogui.generativelanguage.v1beta1.ChunkDataB\x04\xe2A\x01\x02R\x04data\x12b\n" +
	"\x0fcustom_metadata\x18\x03 \x03(\v23.qclaogui.generativelanguage.v1beta1.CustomMetadataB\x04\xe2A\x01\x01R\x0ecustomMetadata\x12A\n" +
	...
	"updateTime\x12L\n" +
	"\x05state\x18\x06 \x01(\x0e20.qclaogui.generativelanguage.v1beta1.Chunk.StateB\x04\xe2A\x01\x03R\x05state\"`\n" +
	"\x05State\x12\x15\n" +
	...
	"\x04dataBVZTgithub.com/qclaogui/gaip/genproto/generativelanguage/apiv1beta1/generativelanguagepbb\x06proto3"
