...
const file_qclaogui_generativelanguage_v1beta1_content_proto_rawDesc = "" +
	"\n" +
	"1qclaogui/generativelanguage/v1beta1/content.proto\x12#qclaogui.generativelanguage.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\"d\n" +
	"\aContent\x12?\n" +
	"\x05parts\x18\x01 \x03(\v2).qclaogui.generativelanguage.v1beta1.PartR\x05parts\x12\x18\n" +
	"\x04role\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\x04role\"\xd0\x04\n" +
	"\x04Part\x12\x14\n" +
	"\x04text\x18\x02 \x01(\tH\x00R\x04text\x12L\n" +
	"\vinline_data\x18\x03 \x01(\v2).qclaogui.generativelanguage.v1beta1.BlobH\x00R\n" +
	"inlineData\x12X\n" +
	"\rfunction_call\x18\x04 \x01(\v21.qclaogui.generativelanguage.v1beta1.FunctionCallH\x00R\ffunctionCall\x12d\n" +
	"\x11function_response\x18\x05 \x01(\v25.qclaogui.generativelanguage.v1beta1.FunctionResponseH\x00R\x10functionResponse\x12L\n" +
	"\tfile_data\x18\x06 \x01(\v2-.qclaogui.generativelanguage.v1beta1.FileDataH\x00R\bfileData\x12^\n" +
	"\x0fexecutable_code\x18\t \x01(\v23.qclaogui.generativelanguage.v1beta1.ExecutableCodeH\x00R\x0eexecutableCode\x12n\n" +
	"\x15code_execution_result\x18\n" +
	" \x01(\v28.qclaogui.generativelanguage.v1beta1.CodeExecutionResultH\x00R\x13codeExecutionResultB\x06\n" +
	"\x04data\"7\n" +
	"\x04Blob\x12\x1b\n" +
	...
	"\bfile_uri\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\afileUri\"\xbc\x01\n" +
	"\x0eExecutableCode\x12^\n" +
	"\blanguage\x18\x01 \x01(\x0e2<.qclaogui.generativelanguage.v1beta1.ExecutableCode.LanguageB\x04\xe2A\x01\x02R\blanguage\x12\x18\n" +
	"\x04code\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\x04code\"0\n" +
	"\bLanguage\x12\x18\n" +
	"\x14LANGUAGE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06PYTHON\x10\x01\"\xfc\x01\n" +
	"\x13CodeExecutionResult\x12`\n" +
	"\aoutcome\x18\x01 \x01(\x0e2@.qclaogui.generativelanguage.v1beta1.CodeExecutionResult.OutcomeB\x04\xe2A\x01\x02R\aoutcome\x12\x1c\n" +
	...
	"\x19OUTCOME_DEADLINE_EXCEEDED\x10\x03\"\xd6\x02\n" +
	"\x04Tool\x12s\n" +
	"\x15function_declarations\x18\x01 \x03(\v28.qclaogui.generativelanguage.v1beta1.FunctionDeclarationB\x04\xe2A\x01\x01R\x14functionDeclarations\x12x\n" +
	"\x17google_search_retrieval\x18\x02 \x01(\v2:.qclaogui.generativelanguage.v1beta1.GoogleSearchRetrievalB\x04\xe2A\x01\x01R\x15googleSearchRetrieval\x12_\n" +
	"\x0ecode_execution\x18\x03 \x01(\v22.qclaogui.generativelanguage.v1beta1.CodeExecutionB\x04\xe2A\x01\x01R\rcodeExecution\"\x8e\x01\n" +
	"\x15GoogleSearchRetrieval\x12u\n" +
	"\x18dynamic_retrieval_config\x18\x01 \x01(\v2;.qclaogui.generativelanguage.v1beta1.DynamicRetrievalConfigR\x16dynamicRetrievalConfig\"\xe6\x01\n" +
	"\x16DynamicRetrievalConfig\x12T\n" +
	"\x04mode\x18\x01 \x01(\x0e2@.qclaogui.generativelanguage.v1beta1.DynamicRetrievalConfig.ModeR\x04mode\x120\n" +
	...
	"\n" +
	"ToolConfig\x12x\n" +
	"\x17function_calling_config\x18\x01 \x01(\v2:.qclaogui.generativelanguage.v1beta1.FunctionCallingConfigB\x04\xe2A\x01\x01R\x15functionCallingConfig\"\xe9\x01\n" +
	"\x15FunctionCallingConfig\x12Y\n" +
	"\x04mode\x18\x01 \x01(\x0e2?.qclaogui.generativelanguage.v1beta1.FunctionCallingConfig.ModeB\x04\xe2A\x01\x01R\x04mode\x12:\n" +
	...
	"\x04NONE\x10\x03\"\xbe\x01\n" +
	"\x13FunctionDeclaration\x12\x18\n" +
	"\x04name\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x04name\x12&\n" +
	"\vdescription\x18\x02 \x01(\tB\x04\xe2A\x01\x02R\vdescription\x12V\n" +
	"\n" +
	"parameters\x18\x03 \x01(\v2+.qclaogui.generativelanguage.v1beta1.SchemaB\x04\xe2A\x01\x01H\x00R\n" +
	...
	"\bresponse\x18\x02 \x01(\v2\x17.google.protobuf.StructB\x04\xe2A\x01\x02R\bresponse\"\xde\x04\n" +
	"\x06Schema\x12C\n" +
	"\x04type\x18\x01 \x01(\x0e2).qclaogui.generativelanguage.v1beta1.TypeB\x04\xe2A\x01\x02R\x04type\x12\x1c\n" +
	...
	"\x04enum\x18\x05 \x03(\tB\x04\xe2A\x01\x01R\x04enum\x12L\n" +
	"\x05items\x18\x06 \x01(\v2+.qclaogui.generativelanguage.v1beta1.SchemaB\x04\xe2A\x01\x01H\x00R\x05items\x88\x01\x01\x12!\n" +
	"\tmax_items\x18\x15 \x01(\x03B\x04\xe2A\x01\x01R\bmaxItems\x12!\n" +
	"\tmin_items\x18\x16 \x01(\x03B\x04\xe2A\x01\x01R\bminItems\x12a\n" +
	"\n" +
	"properties\x18\a \x03(\v2;.qclaogui.generativelanguage.v1beta1.Schema.PropertiesEntryB\x04\xe2A\x01\x01R\n" +
	"properties\x12 \n" +
	"\brequired\x18\b \x03(\tB\x04\xe2A\x01\x01R\brequired\x1aj\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12A\n" +
	"\x05value\x18\x02 \x01(\v2+.qclaogui.generativelanguage.v1beta1.SchemaR\x05value:\x028\x01B\b\n" +
	"\x06_items\"j\n" +
	"\x10GroundingPassage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12F\n" +
	"\acontent\x18\x02 \x01(\v2,.qclaogui.generativelanguage.v1beta1.ContentR\acontent\"f\n" +
	"\x11GroundingPassages\x12Q\n" +
	"\bpassages\x18\x01 \x03(\v25.qclaogui.generativelanguage.v1beta1.GroundingPassageR\bpassages*e\n" +
	"\x04Type\x12\x14\n" +
	...
	"\n" +
	"\x06OBJECT\x10\x06BVZTgithub.com/qclaogui/gaip/genproto/generativelanguage/apiv1beta1/generativelanguagepbb\x06proto3"
