...
const file_qclaogui_generativelanguage_v1beta1_cache_service_proto_rawDesc = "" +
	"\n" +
	"7qclaogui/generativelanguage/v1beta1/cache_service.proto\x12#qclaogui.generativelanguage.v1beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a8qclaogui/generativelanguage/v1beta1/cached_content.proto\"c\n" +
	"\x19ListCachedContentsRequest\x12!\n" +
	"\tpage_size\x18\x01 \x01(\x05B\x04\xe2A\x01\x01R\bpageSize\x12#\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\tpageToken\"\xa1\x01\n" +
	"\x1aListCachedContentsResponse\x12[\n" +
	"\x0fcached_contents\x18\x01 \x03(\v22.qclaogui.generativelanguage.v1beta1.CachedContentR\x0ecachedContents\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"}\n" +
	"\x1aCreateCachedContentRequest\x12_\n" +
	"\x0ecached_content\x18\x01 \x01(\v22.qclaogui.generativelanguage.v1beta1.CachedContentB\x04\xe2A\x01\x02R\rcachedContent\"e\n" +
	"\x17GetCachedContentRequest\x12J\n" +
	"\x04name\x18\x01 \x01(\tB6\xe2A\x01\x02\xfaA/\n" +
	"-generativelanguage.qclaogui.com/CachedContentR\x04name\"\xba\x01\n" +
	"\x1aUpdateCachedContentRequest\x12_\n" +
	"\x0ecached_content\x18\x01 \x01(\v22.qclaogui.generativelanguage.v1beta1.CachedContentB\x04\xe2A\x01\x02R\rcachedContent\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"h\n" +
	"\x1aDeleteCachedContentRequest\x12J\n" +
	"\x04name\x18\x01 \x01(\tB6\xe2A\x01\x02\xfaA/\n" +
	"-generativelanguage.qclaogui.com/CachedContentR\x04name2\x85\b\n" +
	"\fCacheService\x12\xb8\x01\n" +
	"\x12ListCachedContents\x12>.qclaogui.generativelanguage.v1beta1.ListCachedContentsRequest\x1a?.qclaogui.generativelanguage.v1beta1.ListCachedContentsResponse\"!\xdaA\x00\x82\xd3\xe4\x93\x02\x18\x12\x16/v1beta/cachedContents\x12\xcb\x01\n" +
	"\x13CreateCachedContent\x12?.qclaogui.generativelanguage.v1beta1.CreateCachedContentRequest\x1a2.qclaogui.generativelanguage.v1beta1.CachedContent\"?\xdaA\x0ecached_content\x82\xd3\xe4\x93\x02(:\x0ecached_content\"\x16/v1beta/cachedContents\x12\xb4\x01\n" +
	"\x10GetCachedContent\x12<.qclaogui.generativelanguage.v1beta1.GetCachedContentRequest\x1a2.qclaogui.generativelanguage.v1beta1.CachedContent\".\xdaA\x04name\x82\xd3\xe4\x93\x02!\x12\x1f/v1beta/{name=cachedContents/*}\x12\xef\x01\n" +
	"\x13UpdateCachedContent\x12?.qclaogui.generativelanguage.v1beta1.UpdateCachedContentRequest\x1a2.qclaogui.generativelanguage.v1beta1.CachedContent\"c\xdaA\x1acached_content,update_mask\x82\xd3\xe4\x93\x02@:\x0ecached_content2./v1beta/{cached_content.name=cachedContents/*}\x12\x9e\x01\n" +
	"\x13DeleteCachedContent\x12?.qclaogui.generativelanguage.v1beta1.DeleteCachedContentRequest\x1a\x16.google.protobuf.Empty\".\xdaA\x04name\x82\xd3\xe4\x93\x02!*\x1f/v1beta/{name=cachedContents/*}\x1a\"\xcaA\x1fgenerativelanguage.qclaogui.comBVZTgithub.com/qclaogui/gaip/genproto/generativelanguage/apiv1beta1/generativelanguagepbb\x06proto3"
