...
// 	protoc        v6.33.2
// source: qclaogui/generativelanguage/v1beta/safety.proto
...
func (HarmCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[0].Descriptor()
}

func (HarmCategory) Type() protoreflect.EnumType {
	return &file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[0]
}
...
func (HarmCategory) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP(), []int{0}
}
...
func (ContentFilter_BlockedReason) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[1].Descriptor()
}

func (ContentFilter_BlockedReason) Type() protoreflect.EnumType {
	return &file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[1]
}
...
func (ContentFilter_BlockedReason) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP(), []int{0, 0}
}
...
func (SafetyRating_HarmProbability) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[2].Descriptor()
}

func (SafetyRating_HarmProbability) Type() protoreflect.EnumType {
	return &file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[2]
}
...
func (SafetyRating_HarmProbability) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP(), []int{2, 0}
}
...
func (SafetySetting_HarmBlockThreshold) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[3].Descriptor()
}

func (SafetySetting_HarmBlockThreshold) Type() protoreflect.EnumType {
	return &file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes[3]
}
...
func (SafetySetting_HarmBlockThreshold) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP(), []int{3, 0}
}
...
type ContentFilter struct {
	...
	Reason ContentFilter_BlockedReason `protobuf:"varint,1,opt,name=reason,proto3,enum=qclaogui.generativelanguage.v1beta.ContentFilter_BlockedReason" json:"reason,omitempty"`
...
func (x *ContentFilter) Reset() {
	*x = ContentFilter{}
	mi := &file_qclaogui_generativelanguage_v1beta_safety_proto_msgTypes[0]
...
func (x *SafetyFeedback) Reset() {
	*x = SafetyFeedback{}
	mi := &file_qclaogui_generativelanguage_v1beta_safety_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SafetyFeedback) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP(), []int{1}
}
...
type SafetyRating struct {
	...
	Category HarmCategory `protobuf:"varint,3,opt,name=category,proto3,enum=qclaogui.generativelanguage.v1beta.HarmCategory" json:"category,omitempty"`
	// Required. The probability of harm for this content.
	Probability SafetyRating_HarmProbability `protobuf:"varint,4,opt,name=probability,proto3,enum=qclaogui.generativelanguage.v1beta.SafetyRating_HarmProbability" json:"probability,omitempty"`
...
func (x *SafetyRating) Reset() {
	*x = SafetyRating{}
	mi := &file_qclaogui_generativelanguage_v1beta_safety_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SafetyRating) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP(), []int{2}
}
...
type SafetySetting struct {
	...
	Threshold     SafetySetting_HarmBlockThreshold `protobuf:"varint,4,opt,name=threshold,proto3,enum=qclaogui.generativelanguage.v1beta.SafetySetting_HarmBlockThreshold" json:"threshold,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SafetySetting) Reset() {
	*x = SafetySetting{}
	mi := &file_qclaogui_generativelanguage_v1beta_safety_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SafetySetting) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP(), []int{3}
}
...
var File_qclaogui_generativelanguage_v1beta_safety_proto protoreflect.FileDescriptor

const file_qclaogui_generativelanguage_v1beta_safety_proto_rawDesc = "" +
	"\n" +
	"/qclaogui/generativelanguage/v1beta/safety.proto\x12\"qclaogui.generativelanguage.v1beta\x1a\x1fgoogle/api/field_behavior.proto\"\xdb\x01\n" +
	"\rContentFilter\x12W\n" +
	"\x06reason\x18\x01 \x01(\x0e2?.qclaogui.generativelanguage.v1beta.ContentFilter.BlockedReasonR\x06reason\x12\x1d\n" +
	...
	"\n" +
	"\b_message\"\xa7\x01\n" +
	"\x0eSafetyFeedback\x12H\n" +
	"\x06rating\x18\x01 \x01(\v20.qclaogui.generativelanguage.v1beta.SafetyRatingR\x06rating\x12K\n" +
	"\asetting\x18\x02 \x01(\v21.qclaogui.generativelanguage.v1beta.SafetySettingR\asetting\"\xca\x02\n" +
	"\fSafetyRating\x12R\n" +
	"\bcategory\x18\x03 \x01(\x0e20.qclaogui.generativelanguage.v1beta.HarmCategoryB\x04\xe2A\x01\x02R\bcategory\x12h\n" +
	"\vprobability\x18\x04 \x01(\x0e2@.qclaogui.generativelanguage.v1beta.SafetyRating.HarmProbabilityB\x04\xe2A\x01\x02R\vprobability\x12\x18\n" +
	...
	"\x04HIGH\x10\x04\"\xed\x02\n" +
	"\rSafetySetting\x12R\n" +
	"\bcategory\x18\x03 \x01(\x0e20.qclaogui.generativelanguage.v1beta.HarmCategoryB\x04\xe2A\x01\x02R\bcategory\x12h\n" +
	"\tthreshold\x18\x04 \x01(\x0e2D.qclaogui.generativelanguage.v1beta.SafetySetting.HarmBlockThresholdB\x04\xe2A\x01\x02R\tthreshold\"\x9d\x01\n" +
	...
	"\x12!\n" +
	"\x1dHARM_CATEGORY_CIVIC_INTEGRITY\x10\vBUZSgithub.com/qclaogui/gaip/genproto/generativelanguage/apiv1beta/generativelanguagepbb\x06proto3"

var (
	file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescOnce sync.Once
	file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescData []byte
)

func file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescGZIP() []byte {
	file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescOnce.Do(func() {
		file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qclaogui_generativelanguage_v1beta_safety_proto_rawDesc), len(file_qclaogui_generativelanguage_v1beta_safety_proto_rawDesc)))
	})
	return file_qclaogui_generativelanguage_v1beta_safety_proto_rawDescData
}

var (
	file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
	file_qclaogui_generativelanguage_v1beta_safety_proto_msgTypes  = make([]protoimpl.MessageInfo, 4)
	file_qclaogui_generativelanguage_v1beta_safety_proto_goTypes   = []any{
		(HarmCategory)(0),                     // 0: qclaogui.generativelanguage.v1beta.HarmCategory
		(ContentFilter_BlockedReason)(0),      // 1: qclaogui.generativelanguage.v1beta.ContentFilter.BlockedReason
		(SafetyRating_HarmProbability)(0),     // 2: qclaogui.generativelanguage.v1beta.SafetyRating.HarmProbability
		(SafetySetting_HarmBlockThreshold)(0), // 3: qclaogui.generativelanguage.v1beta.SafetySetting.HarmBlockThreshold
		(*ContentFilter)(nil),                 // 4: qclaogui.generativelanguage.v1beta.ContentFilter
		(*SafetyFeedback)(nil),                // 5: qclaogui.generativelanguage.v1beta.SafetyFeedback
		(*SafetyRating)(nil),                  // 6: qclaogui.generativelanguage.v1beta.SafetyRating
		(*SafetySetting)(nil),                 // 7: qclaogui.generativelanguage.v1beta.SafetySetting
	}
)

var file_qclaogui_generativelanguage_v1beta_safety_proto_depIdxs = []int32{
	1, // 0: qclaogui.generativelanguage.v1beta.ContentFilter.reason:type_name -> qclaogui.generativelanguage.v1beta.ContentFilter.BlockedReason
	6, // 1: qclaogui.generativelanguage.v1beta.SafetyFeedback.rating:type_name -> qclaogui.generativelanguage.v1beta.SafetyRating
	7, // 2: qclaogui.generativelanguage.v1beta.SafetyFeedback.setting:type_name -> qclaogui.generativelanguage.v1beta.SafetySetting
	0, // 3: qclaogui.generativelanguage.v1beta.SafetyRating.category:type_name -> qclaogui.generativelanguage.v1beta.HarmCategory
	2, // 4: qclaogui.generativelanguage.v1beta.SafetyRating.probability:type_name -> qclaogui.generativelanguage.v1beta.SafetyRating.HarmProbability
	0, // 5: qclaogui.generativelanguage.v1beta.SafetySetting.category:type_name -> qclaogui.generativelanguage.v1beta.HarmCategory
	3, // 6: qclaogui.generativelanguage.v1beta.SafetySetting.threshold:type_name -> qclaogui.generativelanguage.v1beta.SafetySetting.HarmBlockThreshold
...
func init() { file_qclaogui_generativelanguage_v1beta_safety_proto_init() }
func file_qclaogui_generativelanguage_v1beta_safety_proto_init() {
	if File_qclaogui_generativelanguage_v1beta_safety_proto != nil {
		return
	}
	file_qclaogui_generativelanguage_v1beta_safety_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qclaogui_generativelanguage_v1beta_safety_proto_rawDesc), len(file_qclaogui_generativelanguage_v1beta_safety_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qclaogui_generativelanguage_v1beta_safety_proto_goTypes,
		DependencyIndexes: file_qclaogui_generativelanguage_v1beta_safety_proto_depIdxs,
		EnumInfos:         file_qclaogui_generativelanguage_v1beta_safety_proto_enumTypes,
		MessageInfos:      file_qclaogui_generativelanguage_v1beta_safety_proto_msgTypes,
	}.Build()
	File_qclaogui_generativelanguage_v1beta_safety_proto = out.File
	file_qclaogui_generativelanguage_v1beta_safety_proto_goTypes = nil
	file_qclaogui_generativelanguage_v1beta_safety_proto_depIdxs = nil
}
