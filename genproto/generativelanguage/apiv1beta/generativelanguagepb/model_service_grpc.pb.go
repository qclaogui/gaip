...
const (
	ModelService_GetModel_FullMethodName         = "/qclaogui.generativelanguage.v1beta.ModelService/GetModel"
	ModelService_ListModels_FullMethodName       = "/qclaogui.generativelanguage.v1beta.ModelService/ListModels"
	ModelService_GetTunedModel_FullMethodName    = "/qclaogui.generativelanguage.v1beta.ModelService/GetTunedModel"
	ModelService_ListTunedModels_FullMethodName  = "/qclaogui.generativelanguage.v1beta.ModelService/ListTunedModels"
	ModelService_CreateTunedModel_FullMethodName = "/qclaogui.generativelanguage.v1beta.ModelService/CreateTunedModel"
	ModelService_UpdateTunedModel_FullMethodName = "/qclaogui.generativelanguage.v1beta.ModelService/UpdateTunedModel"
	ModelService_DeleteTunedModel_FullMethodName = "/qclaogui.generativelanguage.v1beta.ModelService/DeleteTunedModel"
)
...
func (c *modelServiceClient) GetTunedModel(ctx context.Context, in *GetTunedModelRequest, opts ...grpc.CallOption) (*TunedModel, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TunedModel)
	err := c.cc.Invoke(ctx, ModelService_GetTunedModel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelServiceClient) ListTunedModels(ctx context.Context, in *ListTunedModelsRequest, opts ...grpc.CallOption) (*ListTunedModelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ModelService_ListTunedModels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelServiceClient) CreateTunedModel(ctx context.Context, in *CreateTunedModelRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	...
	err := c.cc.Invoke(ctx, ModelService_CreateTunedModel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelServiceClient) UpdateTunedModel(ctx context.Context, in *UpdateTunedModelRequest, opts ...grpc.CallOption) (*TunedModel, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TunedModel)
	err := c.cc.Invoke(ctx, ModelService_UpdateTunedModel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelServiceClient) DeleteTunedModel(ctx context.Context, in *DeleteTunedModelRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ModelService_DeleteTunedModel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedModelServiceServer) GetTunedModel(context.Context, *GetTunedModelRequest) (*TunedModel, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTunedModel not implemented")
}
...
func (UnimplementedModelServiceServer) ListTunedModels(context.Context, *ListTunedModelsRequest) (*ListTunedModelsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTunedModels not implemented")
}
...
func (UnimplementedModelServiceServer) CreateTunedModel(context.Context, *CreateTunedModelRequest) (*longrunningpb.Operation, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateTunedModel not implemented")
}

func (UnimplementedModelServiceServer) UpdateTunedModel(context.Context, *UpdateTunedModelRequest) (*TunedModel, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateTunedModel not implemented")
}

func (UnimplementedModelServiceServer) DeleteTunedModel(context.Context, *DeleteTunedModelRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteTunedModel not implemented")
}
...
var ModelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qclaogui.generativelanguage.v1beta.ModelService",
	...
	Metadata: "qclaogui/generativelanguage/v1beta/model_service.proto",
}
