...
const (
	TextService_GenerateText_FullMethodName    = "/qclaogui.generativelanguage.v1beta.TextService/GenerateText"
	TextService_EmbedText_FullMethodName       = "/qclaogui.generativelanguage.v1beta.TextService/EmbedText"
	TextService_BatchEmbedText_FullMethodName  = "/qclaogui.generativelanguage.v1beta.TextService/BatchEmbedText"
	TextService_CountTextTokens_FullMethodName = "/qclaogui.generativelanguage.v1beta.TextService/CountTextTokens"
)
...
func (UnimplementedTextServiceServer) CountTextTokens(context.Context, *CountTextTokensRequest) (*CountTextTokensResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CountTextTokens not implemented")
}
...
var TextService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qclaogui.generativelanguage.v1beta.TextService",
	...
	Metadata: "qclaogui/generativelanguage/v1beta/text_service.proto",
}
