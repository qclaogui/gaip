...
func (UnimplementedGenerativeServiceServer) GenerateAnswer(context.Context, *GenerateAnswerRequest) (*GenerateAnswerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateAnswer not implemented")
}
...
func (UnimplementedGenerativeServiceServer) BidiGenerateContent(grpc.BidiStreamingServer[BidiGenerateContentClientMessage, BidiGenerateContentServerMessage]) error {
	return status.Error(codes.Unimplemented, "method BidiGenerateContent not implemented")
}
