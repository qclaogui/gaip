...
// 	protoc        v6.31.0
// source: qclaogui/generativelanguage/v1beta/retriever.proto
...
func (Condition_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_enumTypes[0].Descriptor()
}

func (Condition_Operator) Type() protoreflect.EnumType {
	return &file_qclaogui_generativelanguage_v1beta_retriever_proto_enumTypes[0]
}
...
func (Condition_Operator) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{5, 0}
}
...
func (Chunk_State) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_enumTypes[1].Descriptor()
}

func (Chunk_State) Type() protoreflect.EnumType {
	return &file_qclaogui_generativelanguage_v1beta_retriever_proto_enumTypes[1]
}
...
func (Chunk_State) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{6, 0}
}
...
func (x *Corpus) Reset() {
	*x = Corpus{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[0]
...
func (*Corpus) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{0}
}
...
func (x *Document) Reset() {
	*x = Document{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Document) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{1}
}
...
func (x *StringList) Reset() {
	*x = StringList{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StringList) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{2}
}
...
func (x *CustomMetadata) Reset() {
	*x = CustomMetadata{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomMetadata) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{3}
}
...
func (x *MetadataFilter) Reset() {
	*x = MetadataFilter{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MetadataFilter) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{4}
}
...
type Condition struct {
	...
	// condition.
	Operation     Condition_Operator `protobuf:"varint,5,opt,name=operation,proto3,enum=qclaogui.generativelanguage.v1beta.Condition_Operator" json:"operation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Condition) Reset() {
	*x = Condition{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Condition) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{5}
}
...
type Chunk struct {
	...
	State         Chunk_State `protobuf:"varint,6,opt,name=state,proto3,enum=qclaogui.generativelanguage.v1beta.Chunk_State" json:"state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Chunk) Reset() {
	*x = Chunk{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Chunk) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{6}
}
...
func (x *ChunkData) Reset() {
	*x = ChunkData{}
	mi := &file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChunkData) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP(), []int{7}
}
...
var File_qclaogui_generativelanguage_v1beta_retriever_proto protoreflect.FileDescriptor

const file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDesc = "" +
	"\n" +
	"2qclaogui/generativelanguage/v1beta/retriever.proto\x12\"qclaogui.generativelanguage.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa2\x02\n" +
	"\x06Corpus\x12\x19\n" +
	"\x04name\x18\x01 \x01(\tB\x05\xe2A\x02\b\x05R\x04name\x12'\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\vdisplayName\x12A\n" +
	...
	"updateTime:N\xeaAK\n" +
	"&generativelanguage.qclaogui.com/Corpus\x12\x10corpora/{corpus}*\acorpora2\x06corpus\"\xa2\x03\n" +
	"\bDocument\x12\x19\n" +
	"\x04name\x18\x01 \x01(\tB\x05\xe2A\x02\b\x05R\x04name\x12'\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x04\xe2A\x01\x01R\vdisplayName\x12a\n" +
	"\x0fcustom_metadata\x18\x03 \x03(\v22.qclaogui.generativelanguage.v1beta.CustomMetadataB\x04\xe2A\x01\x01R\x0ecustomMetadata\x12A\n" +
	"\vupdate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x04\xe2A\x01\x03R\n" +
	"updateTime\x12A\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x04\xe2A\x01\x03R\n" +
	"createTime:i\xeaAf\n" +
	"(generativelanguage.qclaogui.com/Document\x12%corpora/{corpus}/documents/{document}*\tdocuments2\bdocument\"$\n" +
	"\n" +
	"StringList\x12\x16\n" +
	"\x06values\x18\x01 \x03(\tR\x06values\"\xdb\x01\n" +
	"\x0eCustomMetadata\x12#\n" +
	"\fstring_value\x18\x02 \x01(\tH\x00R\vstringValue\x12\\\n" +
	"\x11string_list_value\x18\x06 \x01(\v2..qclaogui.generativelanguage.v1beta.StringListH\x00R\x0fstringListValue\x12%\n" +
	"\rnumeric_value\x18\a \x01(\x02H\x00R\fnumericValue\x12\x16\n" +
	"\x03key\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x03keyB\a\n" +
	"\x05value\"}\n" +
	"\x0eMetadataFilter\x12\x16\n" +
	"\x03key\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x03key\x12S\n" +
	"\n" +
	"conditions\x18\x02 \x03(\v2-.qclaogui.generativelanguage.v1beta.ConditionB\x04\xe2A\x01\x02R\n" +
	"conditions\"\xd3\x02\n" +
	"\tCondition\x12#\n" +
	"\fstring_value\x18\x01 \x01(\tH\x00R\vstringValue\x12%\n" +
	"\rnumeric_value\x18\x06 \x01(\x02H\x00R\fnumericValue\x12Z\n" +
	"\toperation\x18\x05 \x01(\x0e26.qclaogui.generativelanguage.v1beta.Condition.OperatorB\x04\xe2A\x01\x02R\toperation\"\x94\x01\n" +
	"\bOperator\x12\x18\n" +
	...
	"\x05value\"\xf4\x04\n" +
	"\x05Chunk\x12\x19\n" +
	"\x04name\x18\x01 \x01(\tB\x05\xe2A\x02\b\x05R\x04name\x12G\n" +
	"\x04data\x18\x02 \x01(\v2-.qclaogui.generativelanguage.v1beta.ChunkDataB\x04\xe2A\x01\x02R\x04data\x12a\n" +
	"\x0fcustom_metadata\x18\x03 \x03(\v22.qclaogui.generativelanguage.v1beta.CustomMetadataB\x04\xe2A\x01\x01R\x0ecustomMetadata\x12A\n" +
	...
	"updateTime\x12K\n" +
	"\x05state\x18\x06 \x01(\x0e2/.qclaogui.generativelanguage.v1beta.Chunk.StateB\x04\xe2A\x01\x03R\x05state\"`\n" +
	"\x05State\x12\x15\n" +
	...
	"\fSTATE_FAILED\x10\n" +
	":o\xeaAl\n" +
	"%generativelanguage.qclaogui.com/Chunk\x124corpora/{corpus}/documents/{document}/chunks/{chunk}*\x06chunks2\x05chunk\"8\n" +
	"\tChunkData\x12#\n" +
	"\fstring_value\x18\x01 \x01(\tH\x00R\vstringValueB\x06\n" +
	"\x04dataBUZSgithub.com/qclaogui/gaip/genproto/generativelanguage/apiv1beta/generativelanguagepbb\x06proto3"

var (
	file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescOnce sync.Once
	file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescData []byte
)

func file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescGZIP() []byte {
	file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescOnce.Do(func() {
		file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDesc), len(file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDesc)))
	})
	return file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDescData
}

var (
	file_qclaogui_generativelanguage_v1beta_retriever_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
	file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes  = make([]protoimpl.MessageInfo, 8)
	file_qclaogui_generativelanguage_v1beta_retriever_proto_goTypes   = []any{
		(Condition_Operator)(0),       // 0: qclaogui.generativelanguage.v1beta.Condition.Operator
		(Chunk_State)(0),              // 1: qclaogui.generativelanguage.v1beta.Chunk.State
		(*Corpus)(nil),                // 2: qclaogui.generativelanguage.v1beta.Corpus
		(*Document)(nil),              // 3: qclaogui.generativelanguage.v1beta.Document
		(*StringList)(nil),            // 4: qclaogui.generativelanguage.v1beta.StringList
		(*CustomMetadata)(nil),        // 5: qclaogui.generativelanguage.v1beta.CustomMetadata
		(*MetadataFilter)(nil),        // 6: qclaogui.generativelanguage.v1beta.MetadataFilter
		(*Condition)(nil),             // 7: qclaogui.generativelanguage.v1beta.Condition
		(*Chunk)(nil),                 // 8: qclaogui.generativelanguage.v1beta.Chunk
		(*ChunkData)(nil),             // 9: qclaogui.generativelanguage.v1beta.ChunkData
		(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
	}
)

var file_qclaogui_generativelanguage_v1beta_retriever_proto_depIdxs = []int32{
	10, // 0: qclaogui.generativelanguage.v1beta.Corpus.create_time:type_name -> google.protobuf.Timestamp
	10, // 1: qclaogui.generativelanguage.v1beta.Corpus.update_time:type_name -> google.protobuf.Timestamp
	5,  // 2: qclaogui.generativelanguage.v1beta.Document.custom_metadata:type_name -> qclaogui.generativelanguage.v1beta.CustomMetadata
	10, // 3: qclaogui.generativelanguage.v1beta.Document.update_time:type_name -> google.protobuf.Timestamp
	10, // 4: qclaogui.generativelanguage.v1beta.Document.create_time:type_name -> google.protobuf.Timestamp
	4,  // 5: qclaogui.generativelanguage.v1beta.CustomMetadata.string_list_value:type_name -> qclaogui.generativelanguage.v1beta.StringList
	7,  // 6: qclaogui.generativelanguage.v1beta.MetadataFilter.conditions:type_name -> qclaogui.generativelanguage.v1beta.Condition
	0,  // 7: qclaogui.generativelanguage.v1beta.Condition.operation:type_name -> qclaogui.generativelanguage.v1beta.Condition.Operator
	9,  // 8: qclaogui.generativelanguage.v1beta.Chunk.data:type_name -> qclaogui.generativelanguage.v1beta.ChunkData
	5,  // 9: qclaogui.generativelanguage.v1beta.Chunk.custom_metadata:type_name -> qclaogui.generativelanguage.v1beta.CustomMetadata
	10, // 10: qclaogui.generativelanguage.v1beta.Chunk.create_time:type_name -> google.protobuf.Timestamp
	10, // 11: qclaogui.generativelanguage.v1beta.Chunk.update_time:type_name -> google.protobuf.Timestamp
	1,  // 12: qclaogui.generativelanguage.v1beta.Chunk.state:type_name -> qclaogui.generativelanguage.v1beta.Chunk.State
...
func init() { file_qclaogui_generativelanguage_v1beta_retriever_proto_init() }
func file_qclaogui_generativelanguage_v1beta_retriever_proto_init() {
	if File_qclaogui_generativelanguage_v1beta_retriever_proto != nil {
		return
	}
	file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[3].OneofWrappers = []any{
		(*CustomMetadata_StringValue)(nil),
		(*CustomMetadata_StringListValue)(nil),
		(*CustomMetadata_NumericValue)(nil),
	}
	file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[5].OneofWrappers = []any{
		(*Condition_StringValue)(nil),
		(*Condition_NumericValue)(nil),
	}
	file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes[7].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDesc), len(file_qclaogui_generativelanguage_v1beta_retriever_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qclaogui_generativelanguage_v1beta_retriever_proto_goTypes,
		DependencyIndexes: file_qclaogui_generativelanguage_v1beta_retriever_proto_depIdxs,
		EnumInfos:         file_qclaogui_generativelanguage_v1beta_retriever_proto_enumTypes,
		MessageInfos:      file_qclaogui_generativelanguage_v1beta_retriever_proto_msgTypes,
	}.Build()
	File_qclaogui_generativelanguage_v1beta_retriever_proto = out.File
	file_qclaogui_generativelanguage_v1beta_retriever_proto_goTypes = nil
	file_qclaogui_generativelanguage_v1beta_retriever_proto_depIdxs = nil
}
