...
// 	protoc        v6.31.0
// source: qclaogui/generativelanguage/v1beta/tuned_model.proto
...
func (TunedModel_State) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_enumTypes[0].Descriptor()
}

func (TunedModel_State) Type() protoreflect.EnumType {
	return &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_enumTypes[0]
}
...
func (TunedModel_State) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{0, 0}
}
...
type TunedModel struct {
	...
	State TunedModel_State `protobuf:"varint,7,opt,name=state,proto3,enum=qclaogui.generativelanguage.v1beta.TunedModel_State" json:"state,omitempty"`
...
func (x *TunedModel) Reset() {
	*x = TunedModel{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[0]
...
func (*TunedModel) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{0}
}
...
func (x *TunedModelSource) Reset() {
	*x = TunedModelSource{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TunedModelSource) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{1}
}
...
func (x *TuningTask) Reset() {
	*x = TuningTask{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TuningTask) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{2}
}
...
func (x *Hyperparameters) Reset() {
	*x = Hyperparameters{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Hyperparameters) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{3}
}
...
func (x *Dataset) Reset() {
	*x = Dataset{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Dataset) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{4}
}
...
func (x *TuningExamples) Reset() {
	*x = TuningExamples{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TuningExamples) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{5}
}
...
func (x *TuningExample) Reset() {
	*x = TuningExample{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TuningExample) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{6}
}
...
func (x *TuningSnapshot) Reset() {
	*x = TuningSnapshot{}
	mi := &file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TuningSnapshot) Descriptor() ([]byte, []int) {
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP(), []int{7}
}
...
var File_qclaogui_generativelanguage_v1beta_tuned_model_proto protoreflect.FileDescriptor

const file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDesc = "" +
	"\n" +
	"4qclaogui/generativelanguage/v1beta/tuned_model.proto\x12\"qclaogui.generativelanguage.v1beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xeb\a\n" +
	"\n" +
	"TunedModel\x12j\n" +
	"\x12tuned_model_source\x18\x03 \x01(\v24.qclaogui.generativelanguage.v1beta.TunedModelSourceB\x04\xe2A\x01\x01H\x00R\x10tunedModelSource\x12O\n" +
	"\n" +
	"base_model\x18\x04 \x01(\tB.\xe2A\x01\x05\xfaA'\n" +
	"%generativelanguage.qclaogui.com/ModelH\x00R\tbaseModel\x12\x18\n" +
	"\x04name\x18\x01 \x01(\tB\x04\xe2A\x01\x03R\x04name\x12'\n" +
	"\fdisplay_name\x18\x05 \x01(\tB\x04\xe2A\x01\x01R\vdisplayName\x12&\n" +
	"\vdescription\x18\x06 \x01(\tB\x04\xe2A\x01\x01R\vdescription\x12+\n" +
	"\vtemperature\x18\v \x01(\x02B\x04\xe2A\x01\x01H\x01R\vtemperature\x88\x01\x01\x12\x1e\n" +
	"\x05top_p\x18\f \x01(\x02B\x04\xe2A\x01\x01H\x02R\x04topP\x88\x01\x01\x12\x1e\n" +
	"\x05top_k\x18\r \x01(\x05B\x04\xe2A\x01\x01H\x03R\x04topK\x88\x01\x01\x12P\n" +
	"\x05state\x18\a \x01(\x0e24.qclaogui.generativelanguage.v1beta.TunedModel.StateB\x04\xe2A\x01\x03R\x05state\x12A\n" +
	...
	"updateTime\x12U\n" +
	"\vtuning_task\x18\n" +
	" \x01(\v2..qclaogui.generativelanguage.v1beta.TuningTaskB\x04\xe2A\x01\x02R\n" +
	"tuningTask\x12:\n" +
	"\x16reader_project_numbers\x18\x0e \x03(\x03B\x04\xe2A\x01\x01R\x14readerProjectNumbers\"D\n" +
	"\x05State\x12\x15\n" +
	...
	"\n" +
	"\x06FAILED\x10\x03:c\xeaA`\n" +
	"*generativelanguage.qclaogui.com/TunedModel\x12\x19tunedModels/{tuned_model}*\vtunedModels2\n" +
	"tunedModelB\x0e\n" +
	"\fsource_modelB\x0e\n" +
	"\f_temperatureB\b\n" +
	"\x06_top_pB\b\n" +
	"\x06_top_k\"\xb7\x01\n" +
	"\x10TunedModelSource\x12T\n" +
	"\vtuned_model\x18\x01 \x01(\tB3\xe2A\x01\x05\xfaA,\n" +
	"*generativelanguage.qclaogui.com/TunedModelR\n" +
	"tunedModel\x12M\n" +
	"\n" +
	"base_model\x18\x02 \x01(\tB.\xe2A\x01\x03\xfaA'\n" +
	"%generativelanguage.qclaogui.com/ModelR\tbaseModel\"\xab\x03\n" +
	"\n" +
	"TuningTask\x12?\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x04\xe2A\x01\x03R\tstartTime\x12E\n" +
	"\rcomplete_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampB\x04\xe2A\x01\x03R\fcompleteTime\x12V\n" +
	"\tsnapshots\x18\x03 \x03(\v22.qclaogui.generativelanguage.v1beta.TuningSnapshotB\x04\xe2A\x01\x03R\tsnapshots\x12X\n" +
	"\rtraining_data\x18\x04 \x01(\v2+.qclaogui.generativelanguage.v1beta.DatasetB\x06\xe2A\x03\x04\x02\x05R\ftrainingData\x12c\n" +
	"\x0fhyperparameters\x18\x05 \x01(\v23.qclaogui.generativelanguage.v1beta.HyperparametersB\x04\xe2A\x01\x05R\x0fhyperparameters\"\x8f\x02\n" +
	"\x0fHyperparameters\x12,\n" +
	"\rlearning_rate\x18\x10 \x01(\x02B\x05\xe2A\x02\x05\x01H\x00R\flearningRate\x12A\n" +
	"\x18learning_rate_multiplier\x18\x11 \x01(\x02B\x05\xe2A\x02\x05\x01H\x00R\x16learningRateMultiplier\x12*\n" +
	"\vepoch_count\x18\x0e \x01(\x05B\x04\xe2A\x01\x05H\x01R\n" +
	"epochCount\x88\x01\x01\x12(\n" +
	"\n" +
	"batch_size\x18\x0f \x01(\x05B\x04\xe2A\x01\x05H\x02R\tbatchSize\x88\x01\x01B\x16\n" +
	...
	"\x06output\x18\x03 \x01(\tB\x04\xe2A\x01\x02R\x06outputB\r\n" +
	"\vmodel_input\"\xae\x01\n" +
	"\x0eTuningSnapshot\x12\x18\n" +
	"\x04step\x18\x01 \x01(\x05B\x04\xe2A\x01\x03R\x04step\x12\x1a\n" +
	"\x05epoch\x18\x02 \x01(\x05B\x04\xe2A\x01\x03R\x05epoch\x12!\n" +
	"\tmean_loss\x18\x03 \x01(\x02B\x04\xe2A\x01\x03R\bmeanLoss\x12C\n" +
	"\fcompute_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x04\xe2A\x01\x03R\vcomputeTimeBUZSgithub.com/qclaogui/gaip/genproto/generativelanguage/apiv1beta/generativelanguagepbb\x06proto3"

var (
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescOnce sync.Once
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescData []byte
)

func file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescGZIP() []byte {
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescOnce.Do(func() {
		file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDesc), len(file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDesc)))
	})
	return file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDescData
}

var (
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes  = make([]protoimpl.MessageInfo, 8)
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_goTypes   = []any{
		(TunedModel_State)(0),         // 0: qclaogui.generativelanguage.v1beta.TunedModel.State
		(*TunedModel)(nil),            // 1: qclaogui.generativelanguage.v1beta.TunedModel
		(*TunedModelSource)(nil),      // 2: qclaogui.generativelanguage.v1beta.TunedModelSource
		(*TuningTask)(nil),            // 3: qclaogui.generativelanguage.v1beta.TuningTask
		(*Hyperparameters)(nil),       // 4: qclaogui.generativelanguage.v1beta.Hyperparameters
		(*Dataset)(nil),               // 5: qclaogui.generativelanguage.v1beta.Dataset
		(*TuningExamples)(nil),        // 6: qclaogui.generativelanguage.v1beta.TuningExamples
		(*TuningExample)(nil),         // 7: qclaogui.generativelanguage.v1beta.TuningExample
		(*TuningSnapshot)(nil),        // 8: qclaogui.generativelanguage.v1beta.TuningSnapshot
		(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
	}
)

var file_qclaogui_generativelanguage_v1beta_tuned_model_proto_depIdxs = []int32{
	2,  // 0: qclaogui.generativelanguage.v1beta.TunedModel.tuned_model_source:type_name -> qclaogui.generativelanguage.v1beta.TunedModelSource
	0,  // 1: qclaogui.generativelanguage.v1beta.TunedModel.state:type_name -> qclaogui.generativelanguage.v1beta.TunedModel.State
	9,  // 2: qclaogui.generativelanguage.v1beta.TunedModel.create_time:type_name -> google.protobuf.Timestamp
	9,  // 3: qclaogui.generativelanguage.v1beta.TunedModel.update_time:type_name -> google.protobuf.Timestamp
	3,  // 4: qclaogui.generativelanguage.v1beta.TunedModel.tuning_task:type_name -> qclaogui.generativelanguage.v1beta.TuningTask
	9,  // 5: qclaogui.generativelanguage.v1beta.TuningTask.start_time:type_name -> google.protobuf.Timestamp
	9,  // 6: qclaogui.generativelanguage.v1beta.TuningTask.complete_time:type_name -> google.protobuf.Timestamp
	8,  // 7: qclaogui.generativelanguage.v1beta.TuningTask.snapshots:type_name -> qclaogui.generativelanguage.v1beta.TuningSnapshot
	5,  // 8: qclaogui.generativelanguage.v1beta.TuningTask.training_data:type_name -> qclaogui.generativelanguage.v1beta.Dataset
	4,  // 9: qclaogui.generativelanguage.v1beta.TuningTask.hyperparameters:type_name -> qclaogui.generativelanguage.v1beta.Hyperparameters
	6,  // 10: qclaogui.generativelanguage.v1beta.Dataset.examples:type_name -> qclaogui.generativelanguage.v1beta.TuningExamples
	7,  // 11: qclaogui.generativelanguage.v1beta.TuningExamples.examples:type_name -> qclaogui.generativelanguage.v1beta.TuningExample
	9,  // 12: qclaogui.generativelanguage.v1beta.TuningSnapshot.compute_time:type_name -> google.protobuf.Timestamp
...
func init() { file_qclaogui_generativelanguage_v1beta_tuned_model_proto_init() }
func file_qclaogui_generativelanguage_v1beta_tuned_model_proto_init() {
	if File_qclaogui_generativelanguage_v1beta_tuned_model_proto != nil {
		return
	}
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[0].OneofWrappers = []any{
		(*TunedModel_TunedModelSource)(nil),
		(*TunedModel_BaseModel)(nil),
	}
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[3].OneofWrappers = []any{
		(*Hyperparameters_LearningRate)(nil),
		(*Hyperparameters_LearningRateMultiplier)(nil),
	}
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[4].OneofWrappers = []any{
		(*Dataset_Examples)(nil),
	}
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDesc), len(file_qclaogui_generativelanguage_v1beta_tuned_model_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qclaogui_generativelanguage_v1beta_tuned_model_proto_goTypes,
		DependencyIndexes: file_qclaogui_generativelanguage_v1beta_tuned_model_proto_depIdxs,
		EnumInfos:         file_qclaogui_generativelanguage_v1beta_tuned_model_proto_enumTypes,
		MessageInfos:      file_qclaogui_generativelanguage_v1beta_tuned_model_proto_msgTypes,
	}.Build()
	File_qclaogui_generativelanguage_v1beta_tuned_model_proto = out.File
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_goTypes = nil
	file_qclaogui_generativelanguage_v1beta_tuned_model_proto_depIdxs = nil
}
