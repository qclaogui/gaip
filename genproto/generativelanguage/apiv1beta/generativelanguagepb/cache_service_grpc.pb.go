...
const (
	CacheService_ListCachedContents_FullMethodName  = "/qclaogui.generativelanguage.v1beta.CacheService/ListCachedContents"
	CacheService_CreateCachedContent_FullMethodName = "/qclaogui.generativelanguage.v1beta.CacheService/CreateCachedContent"
	CacheService_GetCachedContent_FullMethodName    = "/qclaogui.generativelanguage.v1beta.CacheService/GetCachedContent"
	CacheService_UpdateCachedContent_FullMethodName = "/qclaogui.generativelanguage.v1beta.CacheService/UpdateCachedContent"
	CacheService_DeleteCachedContent_FullMethodName = "/qclaogui.generativelanguage.v1beta.CacheService/DeleteCachedContent"
)
...
func (c *cacheServiceClient) ListCachedContents(ctx context.Context, in *ListCachedContentsRequest, opts ...grpc.CallOption) (*ListCachedContentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CacheService_ListCachedContents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheServiceClient) CreateCachedContent(ctx context.Context, in *CreateCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	...
	err := c.cc.Invoke(ctx, CacheService_CreateCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheServiceClient) GetCachedContent(ctx context.Context, in *GetCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CachedContent)
	err := c.cc.Invoke(ctx, CacheService_GetCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheServiceClient) UpdateCachedContent(ctx context.Context, in *UpdateCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CachedContent)
	err := c.cc.Invoke(ctx, CacheService_UpdateCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheServiceClient) DeleteCachedContent(ctx context.Context, in *DeleteCachedContentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, CacheService_DeleteCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CacheService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qclaogui.generativelanguage.v1beta.CacheService",
	...
	Metadata: "qclaogui/generativelanguage/v1beta/cache_service.proto",
}
