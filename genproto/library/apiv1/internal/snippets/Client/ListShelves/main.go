...
// [START library_v1_generated_LibraryService_ListShelves_sync]
...
func main() {
	...
	for {
		...
		_ = it.Response.(*librarypb.ListShelvesResponse)
	}
}

// [END library_v1_generated_LibraryService_ListShelves_sync]
