...
// internalMessagingClient is an interface that defines the methods available from .
...
func (c *MessagingClient) CreateRoom(ctx context.Context, req *projectpb.CreateRoomRequest, opts ...gax.CallOption) (*projectpb.Room, error) {
...
type messagingGRPCClient struct {
	...
	// The gRPC API client.
	messagingClient projectpb.MessagingServiceClient
...
func NewMessagingClient(ctx context.Context, opts ...option.ClientOption) (*MessagingClient, error) {
	...
	c := &messagingGRPCClient{
		connPool:        connPool,
		messagingClient: projectpb.NewMessagingServiceClient(connPool),
...
func (c *messagingGRPCClient) CreateRoom(ctx context.Context, req *projectpb.CreateRoomRequest, opts ...gax.CallOption) (*projectpb.Room, error) {
...
func (c *messagingGRPCClient) GetRoom(ctx context.Context, req *projectpb.GetRoomRequest, opts ...gax.CallOption) (*projectpb.Room, error) {
...
// GetRoom retrieves the Room with the given resource name.
func (c *messagingRESTClient) GetRoom(ctx context.Context, req *projectpb.GetRoomRequest, opts ...gax.CallOption) (*projectpb.Room, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
