...
// 	protoc        v6.33.2
// source: qclaogui/aiplatform/v1beta1/explanation.proto
...
func (Examples_ExampleGcsSource_DataFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[0].Descriptor()
}

func (Examples_ExampleGcsSource_DataFormat) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[0]
}
...
func (Examples_ExampleGcsSource_DataFormat) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{12, 0, 0}
}
...
func (Presets_Query) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[1].Descriptor()
}

func (Presets_Query) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[1]
}
...
func (Presets_Query) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{13, 0}
}
...
func (Presets_Modality) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[2].Descriptor()
}

func (Presets_Modality) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[2]
}
...
func (Presets_Modality) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{13, 1}
}
...
func (ExamplesOverride_DataFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[3].Descriptor()
}

func (ExamplesOverride_DataFormat) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes[3]
}
...
func (ExamplesOverride_DataFormat) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{16, 0}
}
...
func (x *Explanation) Reset() {
	*x = Explanation{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[0]
...
func (*Explanation) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{0}
}
...
func (x *ModelExplanation) Reset() {
	*x = ModelExplanation{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ModelExplanation) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{1}
}
...
func (x *Attribution) Reset() {
	*x = Attribution{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Attribution) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{2}
}
...
func (x *Neighbor) Reset() {
	*x = Neighbor{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Neighbor) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExplanationSpec) Reset() {
	*x = ExplanationSpec{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationSpec) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{4}
}
...
func (x *ExplanationParameters) Reset() {
	*x = ExplanationParameters{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationParameters) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{5}
}
...
func (x *SampledShapleyAttribution) Reset() {
	*x = SampledShapleyAttribution{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SampledShapleyAttribution) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{6}
}
...
func (x *IntegratedGradientsAttribution) Reset() {
	*x = IntegratedGradientsAttribution{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IntegratedGradientsAttribution) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{7}
}
...
func (x *XraiAttribution) Reset() {
	*x = XraiAttribution{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*XraiAttribution) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{8}
}
...
func (x *SmoothGradConfig) Reset() {
	*x = SmoothGradConfig{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmoothGradConfig) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{9}
}
...
func (x *FeatureNoiseSigma) Reset() {
	*x = FeatureNoiseSigma{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeatureNoiseSigma) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{10}
}
...
func (x *BlurBaselineConfig) Reset() {
	*x = BlurBaselineConfig{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlurBaselineConfig) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{11}
}
...
func (x *Examples) Reset() {
	*x = Examples{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Examples) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{12}
}
...
type Presets struct {
	...
	Query *Presets_Query `protobuf:"varint,1,opt,name=query,proto3,enum=qclaogui.aiplatform.v1beta1.Presets_Query,oneof" json:"query,omitempty"`
	// The modality of the uploaded model, which automatically configures the
	// distance measurement and feature normalization for the underlying example
	// index and queries. If your model does not precisely fit one of these types,
	// it is okay to choose the closest type.
	Modality      Presets_Modality `protobuf:"varint,2,opt,name=modality,proto3,enum=qclaogui.aiplatform.v1beta1.Presets_Modality" json:"modality,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Presets) Reset() {
	*x = Presets{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Presets) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{13}
}
...
func (x *ExplanationSpecOverride) Reset() {
	*x = ExplanationSpecOverride{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationSpecOverride) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{14}
}
...
func (x *ExplanationMetadataOverride) Reset() {
	*x = ExplanationMetadataOverride{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationMetadataOverride) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{15}
}
...
type ExamplesOverride struct {
	...
	DataFormat    ExamplesOverride_DataFormat `protobuf:"varint,5,opt,name=data_format,json=dataFormat,proto3,enum=qclaogui.aiplatform.v1beta1.ExamplesOverride_DataFormat" json:"data_format,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExamplesOverride) Reset() {
	*x = ExamplesOverride{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExamplesOverride) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{16}
}
...
func (x *ExamplesRestrictionsNamespace) Reset() {
	*x = ExamplesRestrictionsNamespace{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExamplesRestrictionsNamespace) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{17}
}
...
func (x *FeatureNoiseSigma_NoiseSigmaForFeature) Reset() {
	*x = FeatureNoiseSigma_NoiseSigmaForFeature{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeatureNoiseSigma_NoiseSigmaForFeature) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{10, 0}
}
...
type Examples_ExampleGcsSource struct {
	...
	DataFormat Examples_ExampleGcsSource_DataFormat `protobuf:"varint,1,opt,name=data_format,json=dataFormat,proto3,enum=qclaogui.aiplatform.v1beta1.Examples_ExampleGcsSource_DataFormat" json:"data_format,omitempty"`
...
func (x *Examples_ExampleGcsSource) Reset() {
	*x = Examples_ExampleGcsSource{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Examples_ExampleGcsSource) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{12, 0}
}
...
func (x *ExplanationMetadataOverride_InputMetadataOverride) Reset() {
	*x = ExplanationMetadataOverride_InputMetadataOverride{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationMetadataOverride_InputMetadataOverride) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP(), []int{15, 0}
}
...
var File_qclaogui_aiplatform_v1beta1_explanation_proto protoreflect.FileDescriptor

const file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDesc = "" +
	"\n" +
	"-qclaogui/aiplatform/v1beta1/explanation.proto\x12\x1bqclaogui.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a6qclaogui/aiplatform/v1beta1/explanation_metadata.proto\x1a$qclaogui/aiplatform/v1beta1/io.proto\"\xac\x01\n" +
	"\vExplanation\x12R\n" +
	"\fattributions\x18\x01 \x03(\v2(.qclaogui.aiplatform.v1beta1.AttributionB\x04\xe2A\x01\x03R\fattributions\x12I\n" +
	"\tneighbors\x18\x02 \x03(\v2%.qclaogui.aiplatform.v1beta1.NeighborB\x04\xe2A\x01\x03R\tneighbors\"o\n" +
	"\x10ModelExplanation\x12[\n" +
	"\x11mean_attributions\x18\x01 \x03(\v2(.qclaogui.aiplatform.v1beta1.AttributionB\x04\xe2A\x01\x03R\x10meanAttributions\"\x8f\x03\n" +
	"\vAttribution\x128\n" +
	"\x15baseline_output_value\x18\x01 \x01(\x01B\x04\xe2A\x01\x03R\x13baselineOutputValue\x128\n" +
	"\x15instance_output_value\x18\x02 \x01(\x01B\x04\xe2A\x01\x03R\x13instanceOutputValue\x12O\n" +
	"\x14feature_attributions\x18\x03 \x01(\v2\x16.google.protobuf.ValueB\x04\xe2A\x01\x03R\x13featureAttributions\x12'\n" +
	"\foutput_index\x18\x04 \x03(\x05B\x04\xe2A\x01\x03R\voutputIndex\x124\n" +
	"\x13output_display_name\x18\x05 \x01(\tB\x04\xe2A\x01\x03R\x11outputDisplayName\x125\n" +
	"\x13approximation_error\x18\x06 \x01(\x01B\x04\xe2A\x01\x03R\x12approximationError\x12%\n" +
	"\voutput_name\x18\a \x01(\tB\x04\xe2A\x01\x03R\n" +
	"outputName\"d\n" +
	"\bNeighbor\x12%\n" +
	"\vneighbor_id\x18\x01 \x01(\tB\x04\xe2A\x01\x03R\n" +
	"neighborId\x121\n" +
	"\x11neighbor_distance\x18\x02 \x01(\x01B\x04\xe2A\x01\x03R\x10neighborDistance\"\xbf\x01\n" +
	"\x0fExplanationSpec\x12X\n" +
	"\n" +
	"parameters\x18\x01 \x01(\v22.qclaogui.aiplatform.v1beta1.ExplanationParametersB\x04\xe2A\x01\x02R\n" +
	"parameters\x12R\n" +
	"\bmetadata\x18\x02 \x01(\v20.qclaogui.aiplatform.v1beta1.ExplanationMetadataB\x04\xe2A\x01\x01R\bmetadata\"\x9d\x04\n" +
	"\x15ExplanationParameters\x12x\n" +
	"\x1bsampled_shapley_attribution\x18\x01 \x01(\v26.qclaogui.aiplatform.v1beta1.SampledShapleyAttributionH\x00R\x19sampledShapleyAttribution\x12\x87\x01\n" +
	" integrated_gradients_attribution\x18\x02 \x01(\v2;.qclaogui.aiplatform.v1beta1.IntegratedGradientsAttributionH\x00R\x1eintegratedGradientsAttribution\x12Y\n" +
	"\x10xrai_attribution\x18\x03 \x01(\v2,.qclaogui.aiplatform.v1beta1.XraiAttributionH\x00R\x0fxraiAttribution\x12C\n" +
	"\bexamples\x18\a \x01(\v2%.qclaogui.aiplatform.v1beta1.ExamplesH\x00R\bexamples\x12\x13\n" +
	...
	"\n" +
	"path_count\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\tpathCount\"\x85\x02\n" +
	"\x1eIntegratedGradientsAttribution\x12#\n" +
	"\n" +
	"step_count\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\tstepCount\x12[\n" +
	"\x12smooth_grad_config\x18\x02 \x01(\v2-.qclaogui.aiplatform.v1beta1.SmoothGradConfigR\x10smoothGradConfig\x12a\n" +
	"\x14blur_baseline_config\x18\x03 \x01(\v2/.qclaogui.aiplatform.v1beta1.BlurBaselineConfigR\x12blurBaselineConfig\"\xf6\x01\n" +
	"\x0fXraiAttribution\x12#\n" +
	"\n" +
	"step_count\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\tstepCount\x12[\n" +
	"\x12smooth_grad_config\x18\x02 \x01(\v2-.qclaogui.aiplatform.v1beta1.SmoothGradConfigR\x10smoothGradConfig\x12a\n" +
	"\x14blur_baseline_config\x18\x03 \x01(\v2/.qclaogui.aiplatform.v1beta1.BlurBaselineConfigR\x12blurBaselineConfig\"\xdb\x01\n" +
	"\x10SmoothGradConfig\x12!\n" +
	"\vnoise_sigma\x18\x01 \x01(\x02H\x00R\n" +
	"noiseSigma\x12`\n" +
	"\x13feature_noise_sigma\x18\x02 \x01(\v2..qclaogui.aiplatform.v1beta1.FeatureNoiseSigmaH\x00R\x11featureNoiseSigma\x12,\n" +
	"\x12noisy_sample_count\x18\x03 \x01(\x05R\x10noisySampleCountB\x14\n" +
	"\x12GradientNoiseSigma\"\xbb\x01\n" +
	"\x11FeatureNoiseSigma\x12d\n" +
	"\vnoise_sigma\x18\x01 \x03(\v2C.qclaogui.aiplatform.v1beta1.FeatureNoiseSigma.NoiseSigmaForFeatureR\n" +
	"noiseSigma\x1a@\n" +
	"\x14NoiseSigmaForFeature\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05sigma\x18\x02 \x01(\x02R\x05sigma\":\n" +
	"\x12BlurBaselineConfig\x12$\n" +
	"\x0emax_blur_sigma\x18\x01 \x01(\x02R\fmaxBlurSigma\"\x8b\x05\n" +
	"\bExamples\x12f\n" +
	"\x12example_gcs_source\x18\x05 \x01(\v26.qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSourceH\x00R\x10exampleGcsSource\x12]\n" +
	"\x1enearest_neighbor_search_config\x18\x02 \x01(\v2\x16.google.protobuf.ValueH\x01R\x1bnearestNeighborSearchConfig\x12@\n" +
	"\apresets\x18\x04 \x01(\v2$.qclaogui.aiplatform.v1beta1.PresetsH\x01R\apresets\x12E\n" +
	"\n" +
	"gcs_source\x18\x01 \x01(\v2&.qclaogui.aiplatform.v1beta1.GcsSourceR\tgcsSource\x12%\n" +
	"\x0eneighbor_count\x18\x03 \x01(\x05R\rneighborCount\x1a\xf3\x01\n" +
	"\x10ExampleGcsSource\x12b\n" +
	"\vdata_format\x18\x01 \x01(\x0e2A.qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSource.DataFormatR\n" +
	"dataFormat\x12E\n" +
	"\n" +
	"gcs_source\x18\x02 \x01(\v2&.qclaogui.aiplatform.v1beta1.GcsSourceR\tgcsSource\"4\n" +
	"\n" +
	"DataFormat\x12\x1b\n" +
	...
	"\x06config\"\x8d\x02\n" +
	"\aPresets\x12E\n" +
	"\x05query\x18\x01 \x01(\x0e2*.qclaogui.aiplatform.v1beta1.Presets.QueryH\x00R\x05query\x88\x01\x01\x12I\n" +
	"\bmodality\x18\x02 \x01(\x0e2-.qclaogui.aiplatform.v1beta1.Presets.ModalityR\bmodality\"\x1e\n" +
	"\x05Query\x12\v\n" +
	...
	"\aTABULAR\x10\x03B\b\n" +
	"\x06_query\"\x9f\x02\n" +
	"\x17ExplanationSpecOverride\x12R\n" +
	"\n" +
	"parameters\x18\x01 \x01(\v22.qclaogui.aiplatform.v1beta1.ExplanationParametersR\n" +
	"parameters\x12T\n" +
	"\bmetadata\x18\x02 \x01(\v28.qclaogui.aiplatform.v1beta1.ExplanationMetadataOverrideR\bmetadata\x12Z\n" +
	"\x11examples_override\x18\x03 \x01(\v2-.qclaogui.aiplatform.v1beta1.ExamplesOverrideR\x10examplesOverride\"\xe7\x02\n" +
	"\x1bExplanationMetadataOverride\x12b\n" +
	"\x06inputs\x18\x01 \x03(\v2D.qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputsEntryB\x04\xe2A\x01\x02R\x06inputs\x1aX\n" +
	"\x15InputMetadataOverride\x12?\n" +
	"\x0finput_baselines\x18\x01 \x03(\v2\x16.google.protobuf.ValueR\x0einputBaselines\x1a\x89\x01\n" +
	"\vInputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12d\n" +
	"\x05value\x18\x02 \x01(\v2N.qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputMetadataOverrideR\x05value:\x028\x01\"\x92\x03\n" +
	"\x10ExamplesOverride\x12%\n" +
	"\x0eneighbor_count\x18\x01 \x01(\x05R\rneighborCount\x12%\n" +
	"\x0ecrowding_count\x18\x02 \x01(\x05R\rcrowdingCount\x12^\n" +
	"\frestrictions\x18\x03 \x03(\v2:.qclaogui.aiplatform.v1beta1.ExamplesRestrictionsNamespaceR\frestrictions\x12+\n" +
	"\x11return_embeddings\x18\x04 \x01(\bR\x10returnEmbeddings\x12Y\n" +
	"\vdata_format\x18\x05 \x01(\x0e28.qclaogui.aiplatform.v1beta1.ExamplesOverride.DataFormatR\n" +
	"dataFormat\"H\n" +
	"\n" +
	"DataFormat\x12\x1b\n" +
	"\x17DATA_FORMAT_UNSPECIFIED\x10\x00\x12\r\n" +
	...
	"\x04deny\x18\x03 \x03(\tR\x04denyBFZDgithub.com/qclaogui/gaip/genproto/aiplatform/apiv1beta1/aiplatformpbb\x06proto3"

var (
	file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescOnce sync.Once
	file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescData []byte
)

func file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescGZIP() []byte {
	file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescOnce.Do(func() {
		file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDesc), len(file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDesc)))
	})
	return file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDescData
}

var (
	file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
	file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes  = make([]protoimpl.MessageInfo, 22)
	file_qclaogui_aiplatform_v1beta1_explanation_proto_goTypes   = []any{
		(Examples_ExampleGcsSource_DataFormat)(0),                 // 0: qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSource.DataFormat
		(Presets_Query)(0),                                        // 1: qclaogui.aiplatform.v1beta1.Presets.Query
		(Presets_Modality)(0),                                     // 2: qclaogui.aiplatform.v1beta1.Presets.Modality
		(ExamplesOverride_DataFormat)(0),                          // 3: qclaogui.aiplatform.v1beta1.ExamplesOverride.DataFormat
		(*Explanation)(nil),                                       // 4: qclaogui.aiplatform.v1beta1.Explanation
		(*ModelExplanation)(nil),                                  // 5: qclaogui.aiplatform.v1beta1.ModelExplanation
		(*Attribution)(nil),                                       // 6: qclaogui.aiplatform.v1beta1.Attribution
		(*Neighbor)(nil),                                          // 7: qclaogui.aiplatform.v1beta1.Neighbor
		(*ExplanationSpec)(nil),                                   // 8: qclaogui.aiplatform.v1beta1.ExplanationSpec
		(*ExplanationParameters)(nil),                             // 9: qclaogui.aiplatform.v1beta1.ExplanationParameters
		(*SampledShapleyAttribution)(nil),                         // 10: qclaogui.aiplatform.v1beta1.SampledShapleyAttribution
		(*IntegratedGradientsAttribution)(nil),                    // 11: qclaogui.aiplatform.v1beta1.IntegratedGradientsAttribution
		(*XraiAttribution)(nil),                                   // 12: qclaogui.aiplatform.v1beta1.XraiAttribution
		(*SmoothGradConfig)(nil),                                  // 13: qclaogui.aiplatform.v1beta1.SmoothGradConfig
		(*FeatureNoiseSigma)(nil),                                 // 14: qclaogui.aiplatform.v1beta1.FeatureNoiseSigma
		(*BlurBaselineConfig)(nil),                                // 15: qclaogui.aiplatform.v1beta1.BlurBaselineConfig
		(*Examples)(nil),                                          // 16: qclaogui.aiplatform.v1beta1.Examples
		(*Presets)(nil),                                           // 17: qclaogui.aiplatform.v1beta1.Presets
		(*ExplanationSpecOverride)(nil),                           // 18: qclaogui.aiplatform.v1beta1.ExplanationSpecOverride
		(*ExplanationMetadataOverride)(nil),                       // 19: qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride
		(*ExamplesOverride)(nil),                                  // 20: qclaogui.aiplatform.v1beta1.ExamplesOverride
		(*ExamplesRestrictionsNamespace)(nil),                     // 21: qclaogui.aiplatform.v1beta1.ExamplesRestrictionsNamespace
		(*FeatureNoiseSigma_NoiseSigmaForFeature)(nil),            // 22: qclaogui.aiplatform.v1beta1.FeatureNoiseSigma.NoiseSigmaForFeature
		(*Examples_ExampleGcsSource)(nil),                         // 23: qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSource
		(*ExplanationMetadataOverride_InputMetadataOverride)(nil), // 24: qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputMetadataOverride
		nil,                         // 25: qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputsEntry
		(*structpb.Value)(nil),      // 26: google.protobuf.Value
		(*ExplanationMetadata)(nil), // 27: qclaogui.aiplatform.v1beta1.ExplanationMetadata
		(*structpb.ListValue)(nil),  // 28: google.protobuf.ListValue
		(*GcsSource)(nil),           // 29: qclaogui.aiplatform.v1beta1.GcsSource
	}
)

var file_qclaogui_aiplatform_v1beta1_explanation_proto_depIdxs = []int32{
	6,  // 0: qclaogui.aiplatform.v1beta1.Explanation.attributions:type_name -> qclaogui.aiplatform.v1beta1.Attribution
	7,  // 1: qclaogui.aiplatform.v1beta1.Explanation.neighbors:type_name -> qclaogui.aiplatform.v1beta1.Neighbor
	6,  // 2: qclaogui.aiplatform.v1beta1.ModelExplanation.mean_attributions:type_name -> qclaogui.aiplatform.v1beta1.Attribution
	26, // 3: qclaogui.aiplatform.v1beta1.Attribution.feature_attributions:type_name -> google.protobuf.Value
	9,  // 4: qclaogui.aiplatform.v1beta1.ExplanationSpec.parameters:type_name -> qclaogui.aiplatform.v1beta1.ExplanationParameters
	27, // 5: qclaogui.aiplatform.v1beta1.ExplanationSpec.metadata:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata
	10, // 6: qclaogui.aiplatform.v1beta1.ExplanationParameters.sampled_shapley_attribution:type_name -> qclaogui.aiplatform.v1beta1.SampledShapleyAttribution
	11, // 7: qclaogui.aiplatform.v1beta1.ExplanationParameters.integrated_gradients_attribution:type_name -> qclaogui.aiplatform.v1beta1.IntegratedGradientsAttribution
	12, // 8: qclaogui.aiplatform.v1beta1.ExplanationParameters.xrai_attribution:type_name -> qclaogui.aiplatform.v1beta1.XraiAttribution
	16, // 9: qclaogui.aiplatform.v1beta1.ExplanationParameters.examples:type_name -> qclaogui.aiplatform.v1beta1.Examples
	28, // 10: qclaogui.aiplatform.v1beta1.ExplanationParameters.output_indices:type_name -> google.protobuf.ListValue
	13, // 11: qclaogui.aiplatform.v1beta1.IntegratedGradientsAttribution.smooth_grad_config:type_name -> qclaogui.aiplatform.v1beta1.SmoothGradConfig
	15, // 12: qclaogui.aiplatform.v1beta1.IntegratedGradientsAttribution.blur_baseline_config:type_name -> qclaogui.aiplatform.v1beta1.BlurBaselineConfig
	13, // 13: qclaogui.aiplatform.v1beta1.XraiAttribution.smooth_grad_config:type_name -> qclaogui.aiplatform.v1beta1.SmoothGradConfig
	15, // 14: qclaogui.aiplatform.v1beta1.XraiAttribution.blur_baseline_config:type_name -> qclaogui.aiplatform.v1beta1.BlurBaselineConfig
	14, // 15: qclaogui.aiplatform.v1beta1.SmoothGradConfig.feature_noise_sigma:type_name -> qclaogui.aiplatform.v1beta1.FeatureNoiseSigma
	22, // 16: qclaogui.aiplatform.v1beta1.FeatureNoiseSigma.noise_sigma:type_name -> qclaogui.aiplatform.v1beta1.FeatureNoiseSigma.NoiseSigmaForFeature
	23, // 17: qclaogui.aiplatform.v1beta1.Examples.example_gcs_source:type_name -> qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSource
	26, // 18: qclaogui.aiplatform.v1beta1.Examples.nearest_neighbor_search_config:type_name -> google.protobuf.Value
	17, // 19: qclaogui.aiplatform.v1beta1.Examples.presets:type_name -> qclaogui.aiplatform.v1beta1.Presets
	29, // 20: qclaogui.aiplatform.v1beta1.Examples.gcs_source:type_name -> qclaogui.aiplatform.v1beta1.GcsSource
	1,  // 21: qclaogui.aiplatform.v1beta1.Presets.query:type_name -> qclaogui.aiplatform.v1beta1.Presets.Query
	2,  // 22: qclaogui.aiplatform.v1beta1.Presets.modality:type_name -> qclaogui.aiplatform.v1beta1.Presets.Modality
	9,  // 23: qclaogui.aiplatform.v1beta1.ExplanationSpecOverride.parameters:type_name -> qclaogui.aiplatform.v1beta1.ExplanationParameters
	19, // 24: qclaogui.aiplatform.v1beta1.ExplanationSpecOverride.metadata:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride
	20, // 25: qclaogui.aiplatform.v1beta1.ExplanationSpecOverride.examples_override:type_name -> qclaogui.aiplatform.v1beta1.ExamplesOverride
	25, // 26: qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.inputs:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputsEntry
	21, // 27: qclaogui.aiplatform.v1beta1.ExamplesOverride.restrictions:type_name -> qclaogui.aiplatform.v1beta1.ExamplesRestrictionsNamespace
	3,  // 28: qclaogui.aiplatform.v1beta1.ExamplesOverride.data_format:type_name -> qclaogui.aiplatform.v1beta1.ExamplesOverride.DataFormat
	0,  // 29: qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSource.data_format:type_name -> qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSource.DataFormat
	29, // 30: qclaogui.aiplatform.v1beta1.Examples.ExampleGcsSource.gcs_source:type_name -> qclaogui.aiplatform.v1beta1.GcsSource
	26, // 31: qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputMetadataOverride.input_baselines:type_name -> google.protobuf.Value
	24, // 32: qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputsEntry.value:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadataOverride.InputMetadataOverride
...
func init() { file_qclaogui_aiplatform_v1beta1_explanation_proto_init() }
func file_qclaogui_aiplatform_v1beta1_explanation_proto_init() {
	if File_qclaogui_aiplatform_v1beta1_explanation_proto != nil {
		return
	}
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_init()
	file_qclaogui_aiplatform_v1beta1_io_proto_init()
	file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[5].OneofWrappers = []any{
	...
	file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[9].OneofWrappers = []any{
		(*SmoothGradConfig_NoiseSigma)(nil),
		(*SmoothGradConfig_FeatureNoiseSigma)(nil),
	}
	file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[12].OneofWrappers = []any{
		(*Examples_ExampleGcsSource_)(nil),
		(*Examples_NearestNeighborSearchConfig)(nil),
		(*Examples_Presets)(nil),
	}
	file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes[13].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDesc), len(file_qclaogui_aiplatform_v1beta1_explanation_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qclaogui_aiplatform_v1beta1_explanation_proto_goTypes,
		DependencyIndexes: file_qclaogui_aiplatform_v1beta1_explanation_proto_depIdxs,
		EnumInfos:         file_qclaogui_aiplatform_v1beta1_explanation_proto_enumTypes,
		MessageInfos:      file_qclaogui_aiplatform_v1beta1_explanation_proto_msgTypes,
	}.Build()
	File_qclaogui_aiplatform_v1beta1_explanation_proto = out.File
	file_qclaogui_aiplatform_v1beta1_explanation_proto_goTypes = nil
	file_qclaogui_aiplatform_v1beta1_explanation_proto_depIdxs = nil
}
