...
const (
	GenAiCacheService_CreateCachedContent_FullMethodName = "/qclaogui.aiplatform.v1beta1.GenAiCacheService/CreateCachedContent"
	GenAiCacheService_GetCachedContent_FullMethodName    = "/qclaogui.aiplatform.v1beta1.GenAiCacheService/GetCachedContent"
	GenAiCacheService_UpdateCachedContent_FullMethodName = "/qclaogui.aiplatform.v1beta1.GenAiCacheService/UpdateCachedContent"
	GenAiCacheService_DeleteCachedContent_FullMethodName = "/qclaogui.aiplatform.v1beta1.GenAiCacheService/DeleteCachedContent"
	GenAiCacheService_ListCachedContents_FullMethodName  = "/qclaogui.aiplatform.v1beta1.GenAiCacheService/ListCachedContents"
)
...
func (c *genAiCacheServiceClient) CreateCachedContent(ctx context.Context, in *CreateCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	...
	err := c.cc.Invoke(ctx, GenAiCacheService_CreateCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) GetCachedContent(ctx context.Context, in *GetCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CachedContent)
	err := c.cc.Invoke(ctx, GenAiCacheService_GetCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) UpdateCachedContent(ctx context.Context, in *UpdateCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CachedContent)
	err := c.cc.Invoke(ctx, GenAiCacheService_UpdateCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) DeleteCachedContent(ctx context.Context, in *DeleteCachedContentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, GenAiCacheService_DeleteCachedContent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) ListCachedContents(ctx context.Context, in *ListCachedContentsRequest, opts ...grpc.CallOption) (*ListCachedContentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GenAiCacheService_ListCachedContents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGenAiCacheServiceServer should be embedded to have
...
func (UnimplementedGenAiCacheServiceServer) GetCachedContent(context.Context, *GetCachedContentRequest) (*CachedContent, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCachedContent not implemented")
}
...
func (UnimplementedGenAiCacheServiceServer) UpdateCachedContent(context.Context, *UpdateCachedContentRequest) (*CachedContent, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateCachedContent not implemented")
}
...
func (UnimplementedGenAiCacheServiceServer) DeleteCachedContent(context.Context, *DeleteCachedContentRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteCachedContent not implemented")
}
...
func (UnimplementedGenAiCacheServiceServer) ListCachedContents(context.Context, *ListCachedContentsRequest) (*ListCachedContentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCachedContents not implemented")
}
func (UnimplementedGenAiCacheServiceServer) testEmbeddedByValue() {}
...
func RegisterGenAiCacheServiceServer(s grpc.ServiceRegistrar, srv GenAiCacheServiceServer) {
	// If the following call panics, it indicates UnimplementedGenAiCacheServiceServer was
...
var GenAiCacheService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qclaogui.aiplatform.v1beta1.GenAiCacheService",
	...
	Metadata: "qclaogui/aiplatform/v1beta1/gen_ai_cache_service.proto",
}
