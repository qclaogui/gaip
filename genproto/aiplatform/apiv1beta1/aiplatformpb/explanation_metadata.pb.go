...
// 	protoc        v6.33.2
// source: qclaogui/aiplatform/v1beta1/explanation_metadata.proto
...
func (ExplanationMetadata_InputMetadata_Encoding) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[0].Descriptor()
}

func (ExplanationMetadata_InputMetadata_Encoding) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[0]
}
...
func (ExplanationMetadata_InputMetadata_Encoding) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (ExplanationMetadata_InputMetadata_Visualization_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[1].Descriptor()
}

func (ExplanationMetadata_InputMetadata_Visualization_Type) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[1]
}
...
func (ExplanationMetadata_InputMetadata_Visualization_Type) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 0, 1, 0}
}
...
func (ExplanationMetadata_InputMetadata_Visualization_Polarity) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[2].Descriptor()
}

func (ExplanationMetadata_InputMetadata_Visualization_Polarity) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[2]
}
...
func (ExplanationMetadata_InputMetadata_Visualization_Polarity) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 0, 1, 1}
}
...
func (ExplanationMetadata_InputMetadata_Visualization_ColorMap) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[3].Descriptor()
}

func (ExplanationMetadata_InputMetadata_Visualization_ColorMap) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[3]
}
...
func (ExplanationMetadata_InputMetadata_Visualization_ColorMap) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 0, 1, 2}
}
...
func (ExplanationMetadata_InputMetadata_Visualization_OverlayType) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[4].Descriptor()
}

func (ExplanationMetadata_InputMetadata_Visualization_OverlayType) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes[4]
}
...
func (ExplanationMetadata_InputMetadata_Visualization_OverlayType) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 0, 1, 3}
}
...
func (x *ExplanationMetadata) Reset() {
	*x = ExplanationMetadata{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes[0]
...
func (*ExplanationMetadata) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0}
}
...
type ExplanationMetadata_InputMetadata struct {
	...
	// IDENTITY.
	Encoding ExplanationMetadata_InputMetadata_Encoding `protobuf:"varint,3,opt,name=encoding,proto3,enum=qclaogui.aiplatform.v1beta1.ExplanationMetadata_InputMetadata_Encoding" json:"encoding,omitempty"`
...
func (x *ExplanationMetadata_InputMetadata) Reset() {
	*x = ExplanationMetadata_InputMetadata{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationMetadata_InputMetadata) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ExplanationMetadata_OutputMetadata) Reset() {
	*x = ExplanationMetadata_OutputMetadata{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationMetadata_OutputMetadata) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *ExplanationMetadata_InputMetadata_FeatureValueDomain) Reset() {
	*x = ExplanationMetadata_InputMetadata_FeatureValueDomain{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ExplanationMetadata_InputMetadata_Visualization struct {
	...
	Type ExplanationMetadata_InputMetadata_Visualization_Type `protobuf:"varint,1,opt,name=type,proto3,enum=qclaogui.aiplatform.v1beta1.ExplanationMetadata_InputMetadata_Visualization_Type" json:"type,omitempty"`
	// Whether to only highlight pixels with positive contributions, negative
	// or both. Defaults to POSITIVE.
	Polarity ExplanationMetadata_InputMetadata_Visualization_Polarity `protobuf:"varint,2,opt,name=polarity,proto3,enum=qclaogui.aiplatform.v1beta1.ExplanationMetadata_InputMetadata_Visualization_Polarity" json:"polarity,omitempty"`
	...
	// influential in blue.
	ColorMap ExplanationMetadata_InputMetadata_Visualization_ColorMap `protobuf:"varint,3,opt,name=color_map,json=colorMap,proto3,enum=qclaogui.aiplatform.v1beta1.ExplanationMetadata_InputMetadata_Visualization_ColorMap" json:"color_map,omitempty"`
	...
	OverlayType   ExplanationMetadata_InputMetadata_Visualization_OverlayType `protobuf:"varint,6,opt,name=overlay_type,json=overlayType,proto3,enum=qclaogui.aiplatform.v1beta1.ExplanationMetadata_InputMetadata_Visualization_OverlayType" json:"overlay_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExplanationMetadata_InputMetadata_Visualization) Reset() {
	*x = ExplanationMetadata_InputMetadata_Visualization{}
	mi := &file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExplanationMetadata_InputMetadata_Visualization) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
var File_qclaogui_aiplatform_v1beta1_explanation_metadata_proto protoreflect.FileDescriptor

const file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDesc = "" +
	"\n" +
	"6qclaogui/aiplatform/v1beta1/explanation_metadata.proto\x12\x1bqclaogui.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xc7\x16\n" +
	"\x13ExplanationMetadata\x12Z\n" +
	"\x06inputs\x18\x01 \x03(\v2<.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputsEntryB\x04\xe2A\x01\x02R\x06inputs\x12]\n" +
	"\aoutputs\x18\x02 \x03(\v2=.qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputsEntryB\x04\xe2A\x01\x02R\aoutputs\x12E\n" +
	"\x1ffeature_attributions_schema_uri\x18\x03 \x01(\tR\x1cfeatureAttributionsSchemaUri\x12.\n" +
	"\x13latent_space_source\x18\x05 \x01(\tR\x11latentSpaceSource\x1a\x9a\x10\n" +
	"\rInputMetadata\x12?\n" +
	"\x0finput_baselines\x18\x01 \x03(\v2\x16.google.protobuf.ValueR\x0einputBaselines\x12*\n" +
	"\x11input_tensor_name\x18\x02 \x01(\tR\x0finputTensorName\x12c\n" +
	"\bencoding\x18\x03 \x01(\x0e2G.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.EncodingR\bencoding\x12\x1a\n" +
	"\bmodality\x18\x04 \x01(\tR\bmodality\x12\x83\x01\n" +
	"\x14feature_value_domain\x18\x05 \x01(\v2Q.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.FeatureValueDomainR\x12featureValueDomain\x12.\n" +
	...
	" \x03(\v2\x16.google.protobuf.ValueR\x10encodedBaselines\x12r\n" +
	"\rvisualization\x18\v \x01(\v2L.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.VisualizationR\rvisualization\x12\x1d\n" +
	"\n" +
	...
	"\x0foriginal_stddev\x18\x04 \x01(\x02R\x0eoriginalStddev\x1a\xaf\a\n" +
	"\rVisualization\x12e\n" +
	"\x04type\x18\x01 \x01(\x0e2Q.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.TypeR\x04type\x12q\n" +
	"\bpolarity\x18\x02 \x01(\x0e2U.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.PolarityR\bpolarity\x12r\n" +
	"\tcolor_map\x18\x03 \x01(\x0e2U.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.ColorMapR\bcolorMap\x126\n" +
	...
	"\foverlay_type\x18\x06 \x01(\x0e2X.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.OverlayTypeR\voverlayType\"6\n" +
	"\x04Type\x12\x14\n" +
	...
	"\x14display_name_mapping\x1ay\n" +
	"\vInputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12T\n" +
	"\x05value\x18\x02 \x01(\v2>.qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadataR\x05value:\x028\x01\x1a{\n" +
	"\fOutputsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12U\n" +
	"\x05value\x18\x02 \x01(\v2?.qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputMetadataR\x05value:\x028\x01BFZDgithub.com/qclaogui/gaip/genproto/aiplatform/apiv1beta1/aiplatformpbb\x06proto3"

var (
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescOnce sync.Once
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescData []byte
)

func file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescGZIP() []byte {
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescOnce.Do(func() {
		file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDesc), len(file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDesc)))
	})
	return file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDescData
}

var (
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes  = make([]protoimpl.MessageInfo, 7)
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_goTypes   = []any{
		(ExplanationMetadata_InputMetadata_Encoding)(0),                  // 0: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Encoding
		(ExplanationMetadata_InputMetadata_Visualization_Type)(0),        // 1: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.Type
		(ExplanationMetadata_InputMetadata_Visualization_Polarity)(0),    // 2: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.Polarity
		(ExplanationMetadata_InputMetadata_Visualization_ColorMap)(0),    // 3: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.ColorMap
		(ExplanationMetadata_InputMetadata_Visualization_OverlayType)(0), // 4: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.OverlayType
		(*ExplanationMetadata)(nil),                                      // 5: qclaogui.aiplatform.v1beta1.ExplanationMetadata
		(*ExplanationMetadata_InputMetadata)(nil),                        // 6: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata
		(*ExplanationMetadata_OutputMetadata)(nil),                       // 7: qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputMetadata
		nil, // 8: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputsEntry
		nil, // 9: qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputsEntry
		(*ExplanationMetadata_InputMetadata_FeatureValueDomain)(nil), // 10: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.FeatureValueDomain
		(*ExplanationMetadata_InputMetadata_Visualization)(nil),      // 11: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization
		(*structpb.Value)(nil), // 12: google.protobuf.Value
	}
)

var file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_depIdxs = []int32{
	8,  // 0: qclaogui.aiplatform.v1beta1.ExplanationMetadata.inputs:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputsEntry
	9,  // 1: qclaogui.aiplatform.v1beta1.ExplanationMetadata.outputs:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputsEntry
	12, // 2: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.input_baselines:type_name -> google.protobuf.Value
	0,  // 3: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.encoding:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Encoding
	10, // 4: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.feature_value_domain:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.FeatureValueDomain
	12, // 5: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.encoded_baselines:type_name -> google.protobuf.Value
	11, // 6: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.visualization:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization
	12, // 7: qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputMetadata.index_display_name_mapping:type_name -> google.protobuf.Value
	6,  // 8: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputsEntry.value:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata
	7,  // 9: qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputsEntry.value:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.OutputMetadata
	1,  // 10: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.type:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.Type
	2,  // 11: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.polarity:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.Polarity
	3,  // 12: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.color_map:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.ColorMap
	4,  // 13: qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.overlay_type:type_name -> qclaogui.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.OverlayType
...
func init() { file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_init() }
func file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_init() {
	if File_qclaogui_aiplatform_v1beta1_explanation_metadata_proto != nil {
		return
	}
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDesc), len(file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_goTypes,
		DependencyIndexes: file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_depIdxs,
		EnumInfos:         file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_enumTypes,
		MessageInfos:      file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_msgTypes,
	}.Build()
	File_qclaogui_aiplatform_v1beta1_explanation_metadata_proto = out.File
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_goTypes = nil
	file_qclaogui_aiplatform_v1beta1_explanation_metadata_proto_depIdxs = nil
}
