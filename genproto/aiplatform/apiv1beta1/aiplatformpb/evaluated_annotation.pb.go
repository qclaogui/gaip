...
// 	protoc        v6.31.1
// source: qclaogui/aiplatform/v1beta1/evaluated_annotation.proto
...
func (EvaluatedAnnotation_EvaluatedAnnotationType) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_enumTypes[0].Descriptor()
}

func (EvaluatedAnnotation_EvaluatedAnnotationType) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_enumTypes[0]
}
...
func (EvaluatedAnnotation_EvaluatedAnnotationType) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescGZIP(), []int{0, 0}
}
...
func (ErrorAnalysisAnnotation_QueryType) Descriptor() protoreflect.EnumDescriptor {
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_enumTypes[1].Descriptor()
}

func (ErrorAnalysisAnnotation_QueryType) Type() protoreflect.EnumType {
	return &file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_enumTypes[1]
}
...
func (ErrorAnalysisAnnotation_QueryType) EnumDescriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescGZIP(), []int{2, 0}
}
...
type EvaluatedAnnotation struct {
	...
	Type EvaluatedAnnotation_EvaluatedAnnotationType `protobuf:"varint,1,opt,name=type,proto3,enum=qclaogui.aiplatform.v1beta1.EvaluatedAnnotation_EvaluatedAnnotationType" json:"type,omitempty"`
...
func (x *EvaluatedAnnotation) Reset() {
	*x = EvaluatedAnnotation{}
	mi := &file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_msgTypes[0]
...
func (*EvaluatedAnnotation) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescGZIP(), []int{0}
}
...
func (x *EvaluatedAnnotationExplanation) Reset() {
	*x = EvaluatedAnnotationExplanation{}
	mi := &file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EvaluatedAnnotationExplanation) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescGZIP(), []int{1}
}
...
type ErrorAnalysisAnnotation struct {
	...
	// The query type used for finding the attributed items.
	QueryType ErrorAnalysisAnnotation_QueryType `protobuf:"varint,2,opt,name=query_type,json=queryType,proto3,enum=qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation_QueryType" json:"query_type,omitempty"`
...
func (x *ErrorAnalysisAnnotation) Reset() {
	*x = ErrorAnalysisAnnotation{}
	mi := &file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ErrorAnalysisAnnotation) Descriptor() ([]byte, []int) {
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescGZIP(), []int{2}
}
...
func (x *ErrorAnalysisAnnotation_AttributedItem) Reset() {
	*x = ErrorAnalysisAnnotation_AttributedItem{}
	mi := &file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto protoreflect.FileDescriptor

const file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc = "" +
	"\n" +
	"6qclaogui/aiplatform/v1beta1/evaluated_annotation.proto\x12\x1bqclaogui.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a-qclaogui/aiplatform/v1beta1/explanation.proto\"\xe0\x05\n" +
	"\x13EvaluatedAnnotation\x12b\n" +
	"\x04type\x18\x01 \x01(\x0e2H.qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.EvaluatedAnnotationTypeB\x04\xe2A\x01\x03R\x04type\x12>\n" +
	"\vpredictions\x18\x02 \x03(\v2\x16.google.protobuf.ValueB\x04\xe2A\x01\x03R\vpredictions\x12A\n" +
	"\rground_truths\x18\x03 \x03(\v2\x16.google.protobuf.ValueB\x04\xe2A\x01\x03R\fgroundTruths\x12H\n" +
	"\x11data_item_payload\x18\x05 \x01(\v2\x16.google.protobuf.ValueB\x04\xe2A\x01\x03R\x0fdataItemPayload\x12B\n" +
	"\x1bevaluated_data_item_view_id\x18\x06 \x01(\tB\x04\xe2A\x01\x03R\x17evaluatedDataItemViewId\x12_\n" +
	"\fexplanations\x18\b \x03(\v2;.qclaogui.aiplatform.v1beta1.EvaluatedAnnotationExplanationR\fexplanations\x12r\n" +
	"\x1aerror_analysis_annotations\x18\t \x03(\v24.qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotationR\x18errorAnalysisAnnotations\"\x7f\n" +
	...
	"\x0eFALSE_NEGATIVE\x10\x03\"\x97\x01\n" +
	"\x1eEvaluatedAnnotationExplanation\x12)\n" +
	"\x10explanation_type\x18\x01 \x01(\tR\x0fexplanationType\x12J\n" +
	"\vexplanation\x18\x02 \x01(\v2(.qclaogui.aiplatform.v1beta1.ExplanationR\vexplanation\"\x8f\x04\n" +
	"\x17ErrorAnalysisAnnotation\x12n\n" +
	"\x10attributed_items\x18\x01 \x03(\v2C.qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.AttributedItemR\x0fattributedItems\x12]\n" +
	"\n" +
	"query_type\x18\x02 \x01(\x0e2>.qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.QueryTypeR\tqueryType\x12#\n" +
	...
	"\x15SAME_CLASS_DISSIMILAR\x10\x03BFZDgithub.com/qclaogui/gaip/genproto/aiplatform/apiv1beta1/aiplatformpbb\x06proto3"

var (
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescOnce sync.Once
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescData []byte
)

func file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescGZIP() []byte {
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescOnce.Do(func() {
		file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc), len(file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc)))
	})
	return file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDescData
}

var (
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_msgTypes  = make([]protoimpl.MessageInfo, 4)
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_goTypes   = []any{
		(EvaluatedAnnotation_EvaluatedAnnotationType)(0), // 0: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.EvaluatedAnnotationType
		(ErrorAnalysisAnnotation_QueryType)(0),           // 1: qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.QueryType
		(*EvaluatedAnnotation)(nil),                      // 2: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation
		(*EvaluatedAnnotationExplanation)(nil),           // 3: qclaogui.aiplatform.v1beta1.EvaluatedAnnotationExplanation
		(*ErrorAnalysisAnnotation)(nil),                  // 4: qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation
		(*ErrorAnalysisAnnotation_AttributedItem)(nil),   // 5: qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.AttributedItem
		(*structpb.Value)(nil),                           // 6: google.protobuf.Value
		(*Explanation)(nil),                              // 7: qclaogui.aiplatform.v1beta1.Explanation
	}
)

var file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_depIdxs = []int32{
	0, // 0: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.type:type_name -> qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.EvaluatedAnnotationType
	6, // 1: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.predictions:type_name -> google.protobuf.Value
	6, // 2: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.ground_truths:type_name -> google.protobuf.Value
	6, // 3: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.data_item_payload:type_name -> google.protobuf.Value
	3, // 4: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.explanations:type_name -> qclaogui.aiplatform.v1beta1.EvaluatedAnnotationExplanation
	4, // 5: qclaogui.aiplatform.v1beta1.EvaluatedAnnotation.error_analysis_annotations:type_name -> qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation
	7, // 6: qclaogui.aiplatform.v1beta1.EvaluatedAnnotationExplanation.explanation:type_name -> qclaogui.aiplatform.v1beta1.Explanation
	5, // 7: qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.attributed_items:type_name -> qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.AttributedItem
	1, // 8: qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.query_type:type_name -> qclaogui.aiplatform.v1beta1.ErrorAnalysisAnnotation.QueryType
...
func init() { file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_init() }
func file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_init() {
	if File_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc), len(file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_goTypes,
		DependencyIndexes: file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_depIdxs,
		EnumInfos:         file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_enumTypes,
		MessageInfos:      file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_msgTypes,
	}.Build()
	File_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto = out.File
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_goTypes = nil
	file_qclaogui_aiplatform_v1beta1_evaluated_annotation_proto_depIdxs = nil
}
