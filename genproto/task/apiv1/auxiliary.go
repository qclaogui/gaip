...
// TaskIterator manages a stream of *taskpb.Task.
type TaskIterator struct {
	...
	InternalFetch func(pageSize int, pageToken string) (results []*taskpb.Task, nextPageToken string, err error)
}
...
func (it *TaskIterator) Next() (*taskpb.Task, error) {
