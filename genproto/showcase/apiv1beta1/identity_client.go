...
type internalIdentityClient interface {
	...
	CreateUser(context.Context, *showcasepb.CreateUserRequest, ...gax.CallOption) (*showcasepb.User, error)
	GetUser(context.Context, *showcasepb.GetUserRequest, ...gax.CallOption) (*showcasepb.User, error)
	ListUsers(context.Context, *showcasepb.ListUsersRequest, ...gax.CallOption) *UserIterator
	UpdateUser(context.Context, *showcasepb.UpdateUserRequest, ...gax.CallOption) (*showcasepb.User, error)
	DeleteUser(context.Context, *showcasepb.DeleteUserRequest, ...gax.CallOption) error
...
func (c *IdentityClient) CreateUser(ctx context.Context, req *showcasepb.CreateUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
	return c.internalClient.CreateUser(ctx, req, opts...)
}

// GetUser retrieves the User with the given uri.
func (c *IdentityClient) GetUser(ctx context.Context, req *showcasepb.GetUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
	return c.internalClient.GetUser(ctx, req, opts...)
}

// ListUsers lists all users.
func (c *IdentityClient) ListUsers(ctx context.Context, req *showcasepb.ListUsersRequest, opts ...gax.CallOption) *UserIterator {
	return c.internalClient.ListUsers(ctx, req, opts...)
}

// UpdateUser updates a user.
func (c *IdentityClient) UpdateUser(ctx context.Context, req *showcasepb.UpdateUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
...
func (c *IdentityClient) DeleteUser(ctx context.Context, req *showcasepb.DeleteUserRequest, opts ...gax.CallOption) error {
...
type identityGRPCClient struct {
	...
	// The gRPC API client.
	identityClient showcasepb.IdentityServiceClient
...
func NewIdentityClient(ctx context.Context, opts ...option.ClientOption) (*IdentityClient, error) {
	...
	c := &identityGRPCClient{
		connPool:         connPool,
		identityClient:   showcasepb.NewIdentityServiceClient(connPool),
...
func (c *identityGRPCClient) GetUser(ctx context.Context, req *showcasepb.GetUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
...
func (c *identityGRPCClient) ListUsers(ctx context.Context, req *showcasepb.ListUsersRequest, opts ...gax.CallOption) *UserIterator {
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, c.xGoogHeaders...)
	opts = append((*c.CallOptions).ListUsers[0:len((*c.CallOptions).ListUsers):len((*c.CallOptions).ListUsers)], opts...)
	it := &UserIterator{}
	req = proto.Clone(req).(*showcasepb.ListUsersRequest)
	it.InternalFetch = func(pageSize int, pageToken string) ([]*showcasepb.User, string, error) {
		resp := &showcasepb.ListUsersResponse{}
		if pageToken != "" {
...
func (c *identityGRPCClient) UpdateUser(ctx context.Context, req *showcasepb.UpdateUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
...
func (c *identityGRPCClient) DeleteUser(ctx context.Context, req *showcasepb.DeleteUserRequest, opts ...gax.CallOption) error {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
...
// CreateUser creates a user.
func (c *identityRESTClient) CreateUser(ctx context.Context, req *showcasepb.CreateUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
...
// GetUser retrieves the User with the given uri.
func (c *identityRESTClient) GetUser(ctx context.Context, req *showcasepb.GetUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListUsers lists all users.
func (c *identityRESTClient) ListUsers(ctx context.Context, req *showcasepb.ListUsersRequest, opts ...gax.CallOption) *UserIterator {
	it := &UserIterator{}
	req = proto.Clone(req).(*showcasepb.ListUsersRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*showcasepb.User, string, error) {
...
// UpdateUser updates a user.
func (c *identityRESTClient) UpdateUser(ctx context.Context, req *showcasepb.UpdateUserRequest, opts ...gax.CallOption) (*showcasepb.User, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetUser()
...
// DeleteUser deletes a user, their profile, and all of their authored messages.
func (c *identityRESTClient) DeleteUser(ctx context.Context, req *showcasepb.DeleteUserRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
